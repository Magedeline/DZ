...
@mapdef Effect "DZ/AsrielAngelOfDeathWingsBackdrop" AsrielAngelOfDeathWingsBackdrop(x::Integer, y::Integer, bgAlpha::Number=1.0, exclude::String="", expansionSpeed::Number=18.0, intensity::Number=1.0, loop::Bool=true, only::String="*", speed::Number=1.0, wingAlpha::Number=1.0, wingScale::Number=1.0)
