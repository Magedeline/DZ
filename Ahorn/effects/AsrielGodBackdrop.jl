...
@mapdef Effect "DZ/AsrielGodBackdrop" AsrielGodBackdrop(x::Integer, y::Integer, alpha::Number=1.0, color::String="FFFFFF", exclude::String="", fadeIn::Bool=false, fadeOut::Bool=false, fadeX::String="", fadeY::String="", flag::String="", flipX::Bool=false, flipY::Bool=false, gridExpansionSpeed::Number=0.3, instantIn::Bool=false, instantOut::Bool=false, intensity::Number=1.0, loopX::Bool=true, loopY::Bool=true, notFlag::String="", only::String="*", rainbowSpeed::Number=2.0, scrollX::Number=1.0, scrollY::Number=1.0, speed::Number=1.0, speedX::Number=0.0, speedY::Number=0.0, starIntensity::Number=1.0, tag::String="")
