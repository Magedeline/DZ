...
@mapdef Effect "DZ/HeavenGatesBackdrop" HeavenGatesBackdrop(x::Integer, y::Integer, astralBirthScale::Number=1.0, gateHeight::Number=100.0, gateWidth::Number=40.0, glowIntensity::Number=1.0, intensity::Number=1.0, only::String="end-saved", speed::Number=1.0, voidRadius::Number=35.0)
