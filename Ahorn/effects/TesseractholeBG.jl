...
@mapdef Effect "DZ/TesseractholeBG" TesseractholeBG(x::Integer, y::Integer, alpha::Number=1.0, direction::Number=1.0, scale::Number=1.0, strength::String="Mild")

const placements = Ahorn.PlacementDict(
    "DZ/TesseractholeBG" => Ahorn.EntityPlacement(TesseractholeBG)
)
