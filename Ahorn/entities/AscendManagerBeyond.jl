...
@mapdef Entity "DZ/AscendManagerBeyond" AscendManagerBeyond(x::Integer, y::Integer, ambience::String="", arrivial::Bool=false, cutscene::String="", dark::Bool=false, height::Integer=32, index::Integer=0, intro_launch::Bool=false, width::Integer=32)
