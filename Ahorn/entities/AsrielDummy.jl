...
@mapdef Entity "DZ/AsrielDummy" AsrielDummy(x::Integer, y::Integer, alpha::Number=1.0, animation::String="idle", facing::Integer=1, isVisible::Bool=true, playAnimationOnSpawn::Bool=false, scale::Number=1.0)
