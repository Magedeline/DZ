...
@mapdef Entity "DZ/AsrielGodBossV2" AsrielGodBossV2(x::Integer, y::Integer, attackSequence::String="", cameraLockY::Bool=true, cameraPastY::Number=120.0, dialog::Bool=true, patternIndex::Integer=0, startHit::Bool=false)
