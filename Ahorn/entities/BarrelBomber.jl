...
@mapdef Entity "DZ/BarrelBomber" BarrelBomber(x::Integer, y::Integer, detectionRange::Integer=80, explosionRadius::Integer=100, fuseTime::Number=1.5, health::Integer=1)
