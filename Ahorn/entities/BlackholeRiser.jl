...
@mapdef Entity "DZ/BlackholeRiser" BlackholeRiser(x::Integer, y::Integer, glitchy::Bool=true, looping::Bool=true, maxHeight::Number=200.0, riseDelay::Number=1.0, speed::Number=120.0, width::Integer=32)
