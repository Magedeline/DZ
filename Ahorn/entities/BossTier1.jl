...
@mapdef Entity "DZ/BossTier1" BossTier1(x::Integer, y::Integer, arenaRadius::Number=150.0, bossType::String="BasicEnemy", gimmick::Integer=0, health::Integer=100, speed::Number=20.0, tier::Integer=1)
