...
@mapdef Entity "DZ/CharaBoost" CharaBoost(x::Integer, y::Integer, canSkip::Bool=false, finalCh19Boost::Bool=false, finalCh19Dialog::String="", finalCh19GoldenBoost::Bool=false, finalCh19PPBoost::Bool=false, lockCamera::Bool=true)
