...
@mapdef Entity "DZ/CharacterRefill" CharacterRefill(x::Integer, y::Integer, characterModeOnly::Bool=false, characterType::Integer=0, customSoundEvent::String="", customSpritePath::String="", dashCount::Integer=1, grantsSpecialAbility::Bool=true, oneUse::Bool=false, refillStamina::Bool=true)
