...
@mapdef Entity "DZ/DXGravityShifter" DXGravityShifter(x::Integer, y::Integer, gravityMultiplier::Number=-1.0, height::Integer=80, startActive::Bool=true, width::Integer=80)
