...
@mapdef Entity "DZ/DXVoidPlatform" DXVoidPlatform(x::Integer, y::Integer, phaseDuration::Number=1.0, phaseInterval::Number=2.0, phaseOffset::Number=0.0, width::Integer=48)
