...
@mapdef Entity "DZ/DataStream" DataStream(x::Integer, y::Integer, direction::String="Right", flowSpeed::Integer=150, streamLength::Integer=200, streamWidth::Integer=32)
