...
@mapdef Entity "DZ/DefeatSwitchGate" DefeatSwitchGate(x::Integer, y::Integer, flag::String="", height::Integer=48, persistent::Bool=false, requiredBossDefeats::Integer=0, requiredEnemyDefeats::Integer=5, useGlobalCounts::Bool=false, width::Integer=16)
