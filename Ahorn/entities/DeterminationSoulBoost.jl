...
@mapdef Entity "DZ/DeterminationSoulBoost" DeterminationSoulBoost(x::Integer, y::Integer, abilityDuration::Number=3.0, boostSpeed::Number=320.0, canSkip::Bool=false, dashPowerMultiplier::Number=1.5, extraDashes::Integer=2, lockCamera::Bool=true, oneUse::Bool=false)
