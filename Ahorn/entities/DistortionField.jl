...
@mapdef Entity "DZ/DistortionField" DistortionField(x::Integer, y::Integer, distortionType::String="Reverse", height::Integer=32, intensity::Number=1.0, width::Integer=32)
