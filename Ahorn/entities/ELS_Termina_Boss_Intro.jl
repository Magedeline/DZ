...
@mapdef Entity "DZ/ELS_Termina_Boss_Intro" ELS_Termina_Boss_Intro(x::Integer, y::Integer, activationMode::String="touch", completionFlag::String="ch21_els_termina_boss_intro", removeAfterTrigger::Bool=true, requireFlag::String="", showSprite::Bool=false, texturePath::String="objects/Ingeste/sampleEntity/idle00")
