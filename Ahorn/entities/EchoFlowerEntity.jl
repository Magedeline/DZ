...
@mapdef Entity "DZ/EchoFlowerEntity" EchoFlowerEntity(x::Integer, y::Integer, cooldownTime::Number=1.0, echoDelay::Number=0.5, echoSpeed::Integer=200, maxEchoes::Integer=3)
