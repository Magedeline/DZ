...
@mapdef Entity "DZ/EnhancedPowerGenerator" EnhancedPowerGenerator(x::Integer, y::Integer, currentFuel::Number=0.0, efficiency::Number=0.8, fuelType::String="none", generatorType::String="solar", isActive::Bool=true, maxFuelCapacity::Number=0.0, particleColor::String="ffff44", powerOutput::Number=25.0, requiresFuel::Bool=false, showParticles::Bool=true)
