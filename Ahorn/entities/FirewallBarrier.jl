...
@mapdef Entity "DZ/FirewallBarrier" FirewallBarrier(x::Integer, y::Integer, energyDrain::Integer=5, height::Integer=32, maxEnergy::Integer=100, startActive::Bool=true, width::Integer=32)
