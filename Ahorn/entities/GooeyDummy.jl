...
@mapdef Entity "DZ/GooeyDummy" GooeyDummy(x::Integer, y::Integer, alpha::Number=1.0, animation::String="idle", autoFollow::Bool=true, facing::Integer=1, followDelay::Number=0.68, isVisible::Bool=true, playAnimationOnSpawn::Bool=true, scale::Number=1.0)
