...
@mapdef Entity "DZ/Gordo" Gordo(x::Integer, y::Integer, moveDistance::Number=48.0, moveSpeed::Number=40.0, movementType::String="Stationary", pauseDuration::Number=0.5)
