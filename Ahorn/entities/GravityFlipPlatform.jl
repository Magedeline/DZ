...
@mapdef Entity "DZ/GravityFlipPlatform" GravityFlipPlatform(x::Integer, y::Integer, cooldown::Number=2.0, height::Integer=8, togglable::Bool=true, width::Integer=16)
