...
@mapdef Entity "DZ/Heartgemmod" Heartgemmod(x::Integer, y::Integer, fake::Bool=false, fakeHeartDialog::String="CH19_WRONG_HEART", keepGoingDialog::String="CH19_KEEP_GOING_KIRBY", removeCameraTriggers::Bool=false)
