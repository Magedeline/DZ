...
@mapdef Entity "DZ/Hole" Hole(x::Integer, y::Integer, Player::Bool=false, affectsEntities::Bool=true, holeType::String="black", radius::Number=64.0, soundEffect::String="event:/game/general/thing_booped", spawnParticles::Bool=true, strength::Number=5.0, teleportDestination::String="")
