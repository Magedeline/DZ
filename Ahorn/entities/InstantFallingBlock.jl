...
@mapdef Entity "DZ/InstantFallingBlock" InstantFallingBlock(x::Integer, y::Integer, behind::Bool=false, climbFall::Bool=true, fallDelay::Number=0.0, fallOnShake::Bool=false, fallOnTouch::Bool=true, finalBoss::Bool=false, height::Integer=16, respawnTime::Number=5.0, shakeIntensity::Number=0.0, tiletype::String="3", width::Integer=16)
