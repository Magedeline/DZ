...
@mapdef Entity "DZ/JumpThru" JumpThru(x::Integer, y::Integer, Player::Bool=false, attachToSolids::Bool=false, height::Integer=8, moveSpeed::Number=0.0, overrideTexture::String="", sinkAmount::Number=0.0, surfaceIndex::Integer=-1, texture::String="wood", width::Integer=24)
