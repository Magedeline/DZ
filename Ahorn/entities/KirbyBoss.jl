...
@mapdef Entity "DZ/KirbyBoss" KirbyBoss(x::Integer, y::Integer, attackCooldown::Number=2.0, bossMusic::String="event:/pusheen/music/miniboss/main0", health::Integer=15)
