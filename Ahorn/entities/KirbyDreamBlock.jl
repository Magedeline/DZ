...
@mapdef Entity "DZ/KirbyDreamBlock" KirbyDreamBlock(x::Integer, y::Integer, below::Bool=false, fastMoving::Bool=false, height::Integer=16, oneUse::Bool=false, width::Integer=16)

const placements = Ahorn.PlacementDict(
    "DZ/KirbyDreamBlock" => Ahorn.EntityPlacement(KirbyDreamBlock)
)
