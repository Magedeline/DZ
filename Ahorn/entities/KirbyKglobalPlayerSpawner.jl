...
@mapdef Entity "DZ/KirbyKglobal::PlayerSpawner" KirbyKglobalPlayerSpawner(x::Integer, y::Integer, enableKirbyMode::Bool=true, spawnCompanion::Bool=false, startingAbility::String="None")
