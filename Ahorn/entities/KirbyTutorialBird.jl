...
@mapdef Entity "DZ/KirbyTutorialBird" KirbyTutorialBird(x::Integer, y::Integer, birdId::String="", caw::Bool=true, controls::String="", dialogs::String="", faceLeft::Bool=true, onlyOnce::Bool=false, startupIndex::Integer=0, triggerOnce::Bool=true)
