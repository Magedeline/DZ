...
@mapdef Entity "DZ/MadelineGodDummy" MadelineGodDummy(x::Integer, y::Integer, alpha::Number=1.0, animation::String="boost", combatActive::Bool=true, facing::Integer=1, isVisible::Bool=true, playAnimationOnSpawn::Bool=true, scale::Number=1.0)
