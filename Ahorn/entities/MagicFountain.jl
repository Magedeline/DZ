...
@mapdef Entity "DZ/MagicFountain" MagicFountain(x::Integer, y::Integer, fountainType::String="healing", healAmount::Integer=1, isActive::Bool=true, particleCount::Integer=50, usesRemaining::Integer=-1)
