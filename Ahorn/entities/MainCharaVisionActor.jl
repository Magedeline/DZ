...
@mapdef Entity "DZ/MainCharaVisionActor" MainCharaVisionActor(x::Integer, y::Integer, PlayerControlled::Bool=false, acceleration::Number=650.0, clampToRoomBounds::Bool=true, driveCameraWhenControlled::Bool=true, facing::String="down", friction::Number=800.0, genocideMode::Bool=true, maxMoveSpeed::Number=90.0)
...
function Ahorn.render(ctx::Ahorn.Cairo.CairoContext, entity::MainCharaVisionActor, room::Maple.Room)
    Ahorn.drawSprite(ctx, "characters/DZ/mainchara_vision/down00", entity.x, entity.y)
end
