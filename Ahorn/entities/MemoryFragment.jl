...
@mapdef Entity "DZ/MemoryFragment" MemoryFragment(x::Integer, y::Integer, dialogueKey::String="MEMORY_FRAGMENT", fragmentId::String="", fragmentNumber::Integer=1, showDialogue::Bool=true)
