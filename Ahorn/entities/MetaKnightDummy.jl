...
@mapdef Entity "DZ/MetaKnightDummy" MetaKnightDummy(x::Integer, y::Integer, alpha::Number=1.0, animation::String="idle", autoFollow::Bool=true, facing::Integer=1, followDelay::Number=0.72, isVisible::Bool=true, playAnimationOnSpawn::Bool=false, scale::Number=1.0)
