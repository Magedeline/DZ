...
@mapdef Entity "DZ/MoltenLava" MoltenLava(x::Integer, y::Integer, Player::Bool=true, damageGracePeriod::Number=0.0, hasBottom::Bool=false, hasTop::Bool=true, height::Integer=32, width::Integer=32)
