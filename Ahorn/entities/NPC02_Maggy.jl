...
@mapdef Entity "DZ/NPC02_Maggy" NPC02_Maggy(x::Integer, y::Integer, dialogKey::String="ingeste_maggy_02_conversation", flagName::String="maggy_02_talked", spriteId::String="magolor")
