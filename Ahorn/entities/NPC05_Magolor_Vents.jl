...
@mapdef Entity "DZ/NPC05_Magolor_Vents" NPC05_Magolor_Vents(x::Integer, y::Integer, dialogKey::String="CH5_MAGGY_VENTS", flagName::String="magolorVentsTalked", spriteId::String="magolor")
