...
@mapdef Entity "DZ/NPC05_Oshiro_Clutter" NPC05_Oshiro_Clutter(x::Integer, y::Integer, dialogKey::String="ingeste_oshiro_05_clutter", flagName::String="oshiro_05_clutter", spriteId::String="oshiro")
