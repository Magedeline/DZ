...
@mapdef Entity "DZ/NPC08_Maggy_Ending" NPC08_Maggy_Ending(x::Integer, y::Integer, dialogKey::String="ingeste_maggy_08_ending", flagName::String="maggy_08_ending", spriteId::String="magolor")
