...
@mapdef Entity "DZ/NPC17_Toriel" NPC17_Toriel(x::Integer, y::Integer, dialogKey::String="ingeste_toriel_17_final", flagName::String="toriel_17_final", spriteId::String="toriel", talking::Bool=false)
