...
@mapdef Entity "DZ/NPC19_Gravestone" NPC19_Gravestone(x::Integer, y::Integer, dialogKey::String="CH19_GRAVESTONE", flagName::String="maddy_gravestone", spriteId::String="maddygrave00")
