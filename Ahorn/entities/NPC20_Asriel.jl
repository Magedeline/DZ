...
@mapdef Entity "DZ/NPC20_Asriel" NPC20_Asriel(x::Integer, y::Integer, dialogKey::String="ingeste_asriel_20_final", flagName::String="asriel_20_final", spriteId::String="asriel", talking::Bool=false)
