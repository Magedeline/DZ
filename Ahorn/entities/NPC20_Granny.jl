...
@mapdef Entity "DZ/NPC20_Granny" NPC20_Granny(x::Integer, y::Integer, dialogKey::String="ingeste_granny_20_final", flagName::String="granny_20_final", spriteId::String="oldlady", talking::Bool=false)
