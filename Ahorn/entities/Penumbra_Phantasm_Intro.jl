...
@mapdef Entity "DZ/Penumbra_Phantasm_Intro" Penumbra_Phantasm_Intro(x::Integer, y::Integer, activationMode::String="touch", completionFlag::String="ch20_penumbra_phantasm_intro", removeAfterTrigger::Bool=true, requireFlag::String="", showSprite::Bool=false, texturePath::String="objects/Ingeste/sampleEntity/idle00")
