...
@mapdef Entity "DZ/PowerGenerator" PowerGenerator(x::Integer, y::Integer, canTeleport::Bool=false, flag::Bool=false, flipX::Bool=false, health::Integer=5, music::String="", music_progress::Integer=-1, music_session::Bool=false)
