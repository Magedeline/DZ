...
@mapdef Entity "DZ/PowerSourceNumber" PowerSourceNumber(x::Integer, y::Integer, flag::String="disable_lightning", glowSprite::String="", gotCollectable::Bool=false, index::Integer=1, numberSprite::String="")
