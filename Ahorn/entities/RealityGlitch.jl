...
@mapdef Entity "DZ/RealityGlitch" RealityGlitch(x::Integer, y::Integer, glitchIntensity::Number=0.5, height::Integer=32, teleportChance::Number=0.1, width::Integer=32)
