...
@mapdef Entity "DZ/RuinsPuzzleSwitch" RuinsPuzzleSwitch(x::Integer, y::Integer, gateId::String="", holdTime::Number=1.0, sequenceOrder::Integer=0, switchType::String="Simple", timerDuration::Number=3.0)
