...
@mapdef Entity "DZ/RuinsSentinel" RuinsSentinel(x::Integer, y::Integer, attackRange::Integer=60, detectionRange::Integer=150, health::Integer=3, moveSpeed::Integer=50, patrolDistance::Integer=100)
