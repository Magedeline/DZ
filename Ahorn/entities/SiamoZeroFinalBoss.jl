...
@mapdef Entity "DZ/SiamoZeroFinalBoss" SiamoZeroFinalBoss(x::Integer, y::Integer, attackSequence::String="", dialog::Bool=true, patternIndex::Integer=4, siamoTier::String="soulBlack", siamoVariant::String="zero", startHit::Bool=false)
