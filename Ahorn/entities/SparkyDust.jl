...
@mapdef Entity "DZ/SparkyDust" SparkyDust(x::Integer, y::Integer, Player::Bool=false, isActive::Bool=true, particleColor::String="ffff00", particleCount::Integer=10, radius::Number=32.0, soundEffect::String="event:/game/general/thing_booped", sparkFrequency::Number=2.0)
