...
@mapdef Entity "DZ/TitanThrone" TitanThrone(x::Integer, y::Integer, activationRadius::Integer=100, autoActivate::Bool=false, bossEntity::String="DZ/KingTitanBoss", cutsceneId::String="CH15_ROARING_TITAN_KING_BATTLE")
