...
@mapdef Entity "DZ/TorielStoveEntity" TorielStoveEntity(x::Integer, y::Integer, canInteract::Bool=true, cookDuration::Number=5.0, dialogueId::String="TORIEL_STOVE", hasPie::Bool=true, healAmount::Integer=3)
