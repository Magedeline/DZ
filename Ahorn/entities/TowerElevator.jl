...
@mapdef Entity "DZ/TowerElevator" TowerElevator(x::Integer, y::Integer, elevatorId::String="", height::Integer=8, moveSpeed::Integer=80, waitTime::Number=1.0, width::Integer=32)
