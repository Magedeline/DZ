...
@mapdef Entity "DZ/TowerGargoyle" TowerGargoyle(x::Integer, y::Integer, detectionRange::Integer=150, glideSpeed::Integer=100, health::Integer=2, swoopSpeed::Integer=250)
