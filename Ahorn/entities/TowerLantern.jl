...
@mapdef Entity "DZ/TowerLantern" TowerLantern(x::Integer, y::Integer, flickerIntensity::Number=0.1, lanternId::String="", lightColor::String="FFA500", lightRadius::Integer=80, startLit::Bool=false)
