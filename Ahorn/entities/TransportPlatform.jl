...
@mapdef Entity "DZ/TransportPlatform" TransportPlatform(x::Integer, y::Integer, height::Integer=8, isActive::Bool=true, moveSpeed::Number=60.0, platformType::String="stone", waitTime::Number=2.0, width::Integer=32)
