...
@mapdef Entity "DZ/TumbleweedCluster" TumbleweedCluster(x::Integer, y::Integer, bounceChance::Number=0.3, pushForce::Integer=100, rollSpeed::Integer=180, tumbleweedCount::Integer=3)
