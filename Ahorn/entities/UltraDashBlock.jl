...
@mapdef Entity "DZ/UltraDashBlock" UltraDashBlock(x::Integer, y::Integer, breakableBySeeker::Bool=true, environment::String="General", height::Integer=16, permanent::Bool=false, tiletype::String="m", width::Integer=16)
