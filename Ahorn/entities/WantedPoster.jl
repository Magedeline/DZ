...
@mapdef Entity "DZ/WantedPoster" WantedPoster(x::Integer, y::Integer, bountyName::String="OUTLAW", bountyReward::Integer=100, enemyCount::Integer=3, enemyType::String="DZ/BanditoRoller")
