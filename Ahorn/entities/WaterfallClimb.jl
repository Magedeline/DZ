...
@mapdef Entity "DZ/WaterfallClimb" WaterfallClimb(x::Integer, y::Integer, flowStrength::Integer=80, height::Integer=64, rushDuration::Number=2.0, rushInterval::Number=5.0, width::Integer=32)
