...
@mapdef Trigger "DZ/AreaCompleteTrigger" AreaCompleteTrigger(x::Integer, y::Integer, hasGoldenStrawberry::Bool=false, hasPinkPlatinumBerry::Bool=false, height::Integer=16, nextLevel::String="", skipCredits::Bool=false, triggerOnce::Bool=true, width::Integer=16)
