...
@mapdef Trigger "DZ/CS09_FakeSavePointTrigger" CS09_FakeSavePointTrigger(x::Integer, y::Integer, height::Integer=16, playerOnly::Bool=true, specificStage::String="auto", triggerOnce::Bool=true, width::Integer=16)
