...
@mapdef Trigger "DZ/CS09_FakeSaveStageCTrigger" CS09_FakeSaveStageCTrigger(x::Integer, y::Integer, height::Integer=16, playerOnly::Bool=true, triggerOnce::Bool=true, width::Integer=16)
