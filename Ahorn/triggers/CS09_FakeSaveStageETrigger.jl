...
@mapdef Trigger "DZ/CS09_FakeSaveStageETrigger" CS09_FakeSaveStageETrigger(x::Integer, y::Integer, height::Integer=16, playerOnly::Bool=true, triggerOnce::Bool=true, width::Integer=16)
