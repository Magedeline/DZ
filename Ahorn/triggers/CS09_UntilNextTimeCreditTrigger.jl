...
@mapdef Trigger "DZ/CS09_UntilNextTimeCreditTrigger" CS09_UntilNextTimeCreditTrigger(x::Integer, y::Integer, height::Integer=16, requireFlag::Bool=false, requiredFlag::String="", triggerOnce::Bool=true, width::Integer=16)
