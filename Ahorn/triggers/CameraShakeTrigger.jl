...
@mapdef Trigger "DZ/CameraShakeTrigger" CameraShakeTrigger(x::Integer, y::Integer, duration::Number=0.5, height::Integer=16, intensity::Number=0.3, width::Integer=16)
