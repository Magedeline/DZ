...
@mapdef Trigger "DZ/CompanionSummonTrigger" CompanionSummonTrigger(x::Integer, y::Integer, companionType::String="Bandana_Dee", height::Integer=16, width::Integer=16)
