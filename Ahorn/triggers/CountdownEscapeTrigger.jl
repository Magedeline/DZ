...
@mapdef Trigger "DZ/CountdownEscapeTrigger" CountdownEscapeTrigger(x::Integer, y::Integer, countdown::Number=60.0, height::Integer=16, targetRoom::String="", warningTime::Number=10.0, width::Integer=16)
