...
@mapdef Trigger "DZ/DamageTrigger" DamageTrigger(x::Integer, y::Integer, cooldown::Number=1.0, damage::Integer=1, height::Integer=16, removeAfterHit::Bool=false, width::Integer=16)
