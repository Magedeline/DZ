...
@mapdef Trigger "DZ/DialogTrigger" DialogTrigger(x::Integer, y::Integer, dialogKey::String="DIALOG_DEFAULT", height::Integer=16, npcName::String="", requireInteraction::Bool=false, triggerOnce::Bool=true, width::Integer=16)
