...
@mapdef Trigger "DZ/EnemySpawnTrigger" EnemySpawnTrigger(x::Integer, y::Integer, count::Integer=1, enemyType::String="WaddleDee", height::Integer=16, respawn::Bool=false, spawnDelay::Number=0.0, width::Integer=16)
