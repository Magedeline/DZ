...
@mapdef Trigger "DZ/EnemyWaveTrigger" EnemyWaveTrigger(x::Integer, y::Integer, enemiesPerWave::Integer=3, height::Integer=32, spawnDelay::Number=2.0, waveCount::Integer=3, width::Integer=32)
