...
@mapdef Trigger "DZ/KirbyAbilityTrigger" KirbyAbilityTrigger(x::Integer, y::Integer, ability::String="Fire", action::String="Give", height::Integer=16, onlyOnce::Bool=false, width::Integer=16)
