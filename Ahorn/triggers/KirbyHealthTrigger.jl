...
@mapdef Trigger "DZ/KirbyHealthTrigger" KirbyHealthTrigger(x::Integer, y::Integer, enableHealth::Bool=true, fullHeal::Bool=false, healAmount::Integer=0, height::Integer=16, maxHealth::Integer=6, onlyOnce::Bool=true, setRespawnPoint::Bool=false, width::Integer=16)
