...
@mapdef Trigger "DZ/KirbyKnightTrigger" KirbyKnightTrigger(x::Integer, y::Integer, autoTransform::Bool=false, height::Integer=16, mode::String="Enable", onlyOnce::Bool=true, playEffects::Bool=true, requiredFlag::String="", transformDelay::Number=0.0, width::Integer=16)
