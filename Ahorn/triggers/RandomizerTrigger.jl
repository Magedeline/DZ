...
@mapdef Trigger "DZ/RandomizerTrigger" RandomizerTrigger(x::Integer, y::Integer, height::Integer=16, randomizeAbilities::Bool=true, randomizeGravity::Bool=false, randomizeSpeed::Bool=false, width::Integer=16)
