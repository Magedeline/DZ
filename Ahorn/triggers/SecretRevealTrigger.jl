...
@mapdef Trigger "DZ/SecretRevealTrigger" SecretRevealTrigger(x::Integer, y::Integer, flag::String="secret_found", height::Integer=16, revealSound::String="", width::Integer=16)
