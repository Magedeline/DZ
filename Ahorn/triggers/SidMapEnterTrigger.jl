...
@mapdef Trigger "DZ/SidMapEnterTrigger" SidMapEnterTrigger(x::Integer, y::Integer, height::Integer=80, lockedDialogKey::String="RUINS_SM_LOCKED", requiredFlag::String="", targetRoom::String="lvl_sm1_start", targetSid::String="Maggy/SmallMaps/10_Ruins_SM1", width::Integer=40)
