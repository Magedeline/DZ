...
@mapdef Trigger "DZ/TeleportTrigger" TeleportTrigger(x::Integer, y::Integer, height::Integer=16, targetRoom::String="", targetX::Integer=0, targetY::Integer=0, width::Integer=16)
