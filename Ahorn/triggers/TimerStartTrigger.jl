...
@mapdef Trigger "DZ/TimerStartTrigger" TimerStartTrigger(x::Integer, y::Integer, duration::Number=60.0, height::Integer=16, timerId::String="timer_1", width::Integer=16)
