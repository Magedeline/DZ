...
public static class KirbyAudioHook
{
    ...
    public static void Load()
    {
        ...
        if (settings == null || settings.AudioThemeMode != global::Celeste.Mod.MaggyHelper.AudioThemeMode.Kirby)
        {
            Logger.Log(LogLevel.Info, "MaggyHelper", "KirbyAudioHook skipped - Kirby theme not selected");
            return;
        }
        ...
        Logger.Log(LogLevel.Info, "MaggyHelper", "KirbyAudioHook loaded - vanilla audio will be replaced with custom Kirby audio");
    }
    ...
    public static void Unload()
    {
        ...
        Logger.Log(LogLevel.Info, "MaggyHelper", "KirbyAudioHook unloaded");
    }
    ...
    private static void InitializeAudioMappings()
    {
        ...
        Logger.Log(LogLevel.Info, "MaggyHelper", $"KirbyAudioHook: Loaded {_audioReplacements.Count} audio replacement mappings");
    }
    ...
    private static string ReplaceAudioPath(string originalPath)
    {
        ...
        {
            Logger.Log(LogLevel.Debug, "MaggyHelper/KirbyAudioHook",
