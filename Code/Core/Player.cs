...
#pragma warning restore CL013
        ...
        private void AirDriftBegin()
        {
            ...
            if (level != null)
            {
                ...
                Audio.Play("event:/char/pusheen/kirby/dash_charge", Position);
            }
        }
        ...
        private void CycloneSlashBegin()
        {
            ...
            if (level != null)
            {
                ...
                level.Shake(0.15f);
                Audio.Play("event:/char/pusheen/kirby/kirby_knight/spin", Position);
            }
        ...
        private void StarShotBegin()
        {
            ...
            if (level != null)
                Audio.Play("event:/char/pusheen/kirby/inhale_start", Position);
        }
        ...
        private void FireStarShot(float charge)
        {
            ...
            Audio.Play("event:/char/pusheen/kirby/spit", Position);
        ...
        private void SlideTackleBegin()
        {
            ...
            if (level != null)
            {
                ...
                level.Shake(0.1f);
                Audio.Play("event:/char/pusheen/kirby/kirby_knight/punch_A", Position);
            }
        }
        ...
        private void PerformParryCounter()
        {
            ...
            level.Shake(0.3f);
            Audio.Play("event:/char/pusheen/kirby/transform_in", Position);
        ...
        private void DiveKickBegin()
        {
            ...
            if (level != null)
            {
                ...
                level.Shake(0.2f);
                Audio.Play("event:/char/pusheen/kirby/kirby_knight/punch_Final", Position);
            }
        }
