...
public static class PusheenAudioHook
{
    ...
    public static void Load()
    {
        ...
        if (settings == null || settings.AudioThemeMode != global::Celeste.Mod.MaggyHelper.AudioThemeMode.Pusheen)
        {
            Logger.Log(LogLevel.Info, "MaggyHelper", "PusheenAudioHook skipped - Pusheen theme not selected");
            return;
        }
