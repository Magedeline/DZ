...
namespace Celeste
{
    ...
    ///   1. <see cref="global::Celeste.Mod.MaggyHelper.MaggyHelperModule.SaveData"/>.<c>VoidMoonUnlocked</c> is true (set after completing Ch19), AND
    ...
    public static class VoidMoonManager
    {
        ...
        internal static bool ShouldShowVoidMoon(int? currentArea = null)
        {
            ...
            if (global::Celeste.Mod.MaggyHelper.MaggyHelperModule.SaveData?.VoidMoonUnlocked != true)
                return false;
