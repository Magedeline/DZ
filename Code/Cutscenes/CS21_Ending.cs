...
namespace Celeste.Cutscenes
{
	...
	public class CS21_Ending : CutsceneEntity
	{
		...
		private IEnumerator Cutscene(Level level)
		{
			...
			yield return 1f;
			yield return Textbox.Say("MAGGYHELPER_CH21_END_CINEMATIC", new Func<IEnumerator>[]
			{
		...
		public override void OnEnd(Level level)
		{
			...
			{
				Audio.SetMusic("event:/new_content/music/pusheen/lvl20/cinematic/end", true, true);
			}
			Audio.SetMusicParam("end", 1f);
			this.frame = 21;
			this.zoom = 1f;
