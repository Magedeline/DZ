...
internal class LargeHeartGemDoor : Entity
{
    ...
    public IEnumerator Routine()
    {
        ...
        if (this.startHidden)
        {
            ...
            Audio.Play("event:/new_content/game/pusheen/19_spaces/large_heart_door", this.Position);
            this.Visible = true;
            this.heartAlpha = 0f;
    ...
    private IEnumerator OpenCutscene(Level level)
    {
        ...
        this.cutsceneMusic = Audio.Play("event:/new_content/music/pusheen/lvl19/cinematic/BEB_cutscenes", this.Position);
