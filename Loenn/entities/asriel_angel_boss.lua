...
asrielAngelBoss.placements = {
    {
        ...
        data = {
            ...
            -- Music tracks
            musicBurnInDespair = "event:/pusheen/final_content/music/lvl20/burn_in_despair",
            musicHisTheme01 = "event:/pusheen/final_content/music/lvl20/his_theme01",
            musicHisTheme02 = "event:/pusheen/final_content/music/lvl20/his_theme02",
            musicKirbyVsAsriel = "event:/pusheen/final_content/music/lvl20/kirby_vs_asriel_fight_02",
            -- Phase configuration
            barrierWidth = 400,
            barrierHeight = 300,
            riseSpeed = 3.0,
