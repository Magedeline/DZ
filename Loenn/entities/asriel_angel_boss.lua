...
asrielAngelBoss.name = "DZ/AsrielAngelOfDeathBoss"
...
asrielAngelBoss.placements = {
    {
        ...
        data = {
            ...
            musicHisTheme01 = "event:/pusheen/new_content/music/lvl20/his_theme01",
            musicHisTheme02 = "event:/pusheen/new_content/music/lvl20/his_theme02",
            musicKirbyVsAsriel = "event:/pusheen/new_content/music/lvl20/kirby_vs_asriel_fight_02",
            -- Phase configuration
            barrierWidth = 400,
            barrierHeight = 300,
            riseSpeed = 3.0,
            -- Dialog keys
            dialogPhase1 = "DZ_CH20_ASRIEL_ZERO_RISE_KILL",
            dialogStruggle = "DZ_CH20_ASRIEL_ZERO_STRUGGLE_START",
            dialogVoidAnswer = "DZ_CH20_ASRIEL_ZERO_VOID_ANSWERS",
            dialogFlashback = "DZ_CH20_ASRIEL_REMEMBER_A"
        }
    },
    {
        name = "hard_mode",
