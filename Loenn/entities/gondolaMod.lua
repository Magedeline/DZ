...
gondolaMod.name = "DZ/Gondola"
gondolaMod.depth = -10500
gondolaMod.nodeVisibility = "always"
gondolaMod.nodeLimits = {1, 1}
gondolaMod.placements = {
    {
        name = "gondola",
        placementType = "line",
        data = {
...
local frontTexture = "objects/DZ/gondola/front"
local backTexture = "objects/DZ/gondola/back"
local topTexture = "objects/DZ/gondola/top"
local leverTexture = "objects/DZ/gondola/lever01"
local leftTexture = "objects/DZ/gondola/cliffsideLeft"
local rightTexture = "objects/DZ/gondola/cliffsideRight"
...
function gondolaMod.sprite(room, entity)
    local sprites = {}
...
function gondolaMod.selection(room, entity)
    local active = entity.active
    local gondolaPosition = getGondolaPosition(room, entity)
...
function gondolaMod.nodeSprite(room, entity, node)
    local rightSprite = getRightSprite(room, entity)
    local active = entity.active
