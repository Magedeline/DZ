...
largeHeartDoorMod.name = "DZ/LargeHeartDoorMod"
largeHeartDoorMod.depth = 0
largeHeartDoorMod.nodeLimits = {0, 1}
largeHeartDoorMod.warnBelowSize = {40, 8}
...
local edgeTexture = "objects/DZ/heartdoor/edge"
local heartTexture = "objects/DZ/heartdoor/icon00"
...
function largeHeartDoorMod.drawSelected(room, layer, entity, color)
