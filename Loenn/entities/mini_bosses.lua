...
metaKnightTerminatorBoss.name = "MaggyHelper/MetaKnightTerminatorBoss"
...
digitalKingDDDBoss.name = "MaggyHelper/DigitalKingDDDBoss"
...
martletBirdPossessBoss.name = "MaggyHelper/MartletBirdPossessBoss"
