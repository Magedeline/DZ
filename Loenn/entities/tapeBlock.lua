...
tapeeBlock.name = "DZ/TapeBlock"
tapeeBlock.warnBelowSize = {16, 16}
tapeeBlock.fieldInformation = {
    index = {
        fieldType = "integer",
        options = colorNames,
        editable = false
...
tapeeBlock.placements = {}

for i, _ in ipairs(colors) do
    tapeeBlock.placements[i] = {
...
-- Filter by tapee blocks sharing the same index
...
function tapeeBlock.sprite(room, entity)
