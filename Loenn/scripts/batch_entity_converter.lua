...
Converter.Presets = {
    ...
    toKirbyFire = {
        ...
        target = "MaggyHelper/KirbyPlayerSpawner",
        data = {
    ...
    toVanillaPlayer = {
        source = {"MaggyHelper/KirbyPlayerSpawner", "MaggyHelper/K_Player"},
        target = "player",
        data = {}
    }
}
    ...
    for _, room in ipairs(map.rooms) do
        if room.entities then
            for _, entity in ipairs(room.entities) do
                ...
                elseif entity.name == "MaggyHelper/KirbyPlayerSpawner" then
                    counts.kirbyPlayerSpawner = counts.kirbyPlayerSpawner + 1
                elseif entity.name == "MaggyHelper/K_Player" then
                    counts.kPlayer = counts.kPlayer + 1
                elseif entity.name == "MaggyHelper/KirbyPlayerCore" then
