...
-- Useful for porting DoonvHelper/DashCodeGate -> DZ/DashCodeGate
...
local DEFAULT_REPLACEMENTS = {
    ...
    ["DoonvHelper/DashCodeGate"] = "DZ/DashCodeGate",
    -- Add more replacements as needed
    -- ["MaxHelpingHand/SomeEntity"] = "DZ/SomeEntity",
    }
...
script.fieldInformation = {
    ...
    newPrefix = {
        fieldType = "string",
        description = "Your mod prefix (e.g., DZ)"
    },
    specificEntity = {
        fieldType = "string",
