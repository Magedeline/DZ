...
chapterLobbyEnterTrigger.name        = "DZ/ChapterLobbyEnterTrigger"
...
chapterLobbyEnterTrigger.placements = {
    ...
    {
        name = "DZ_CH11 – Enter Snowdin City Lobby",
        data = {
            width           = 16, height          = 64,
    ...
    {
        name = "DZ_CH12 – Enter Wateredgefalls Lobby",
        data = {
            width           = 16, height          = 64,
    ...
    {
        name = "DZ_CH13 – Enter Hotcliffland Lobby",
        data = {
            width           = 16, height          = 64,
    ...
    {
        name = "DZ_CH14 – Enter Cyber Nexus Lobby",
        data = {
            width           = 16, height          = 64,
