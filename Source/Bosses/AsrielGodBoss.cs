...
#pragma warning restore CS0414
        ...
        /// Note: Backdrops are typically added via the map editor (Lönn) as stylegrounds.
        ...
        private IEnumerator TeleportToHyperGonerRoom()
        {
            ...
            Logger.Log(LogLevel.Info, "MaggyHelper", "[AsrielGodBoss] Teleported player to azzyboss-hypergoner room");
