...
{
    /// <summary>
    /// Base class for all boss entities in DZ
    /// </summary>
    [Tracked(true)]
    public abstract class BaseBoss : Actor, IKirbyCopySource
    {
        ...
        {
            maxHealth = data.Int("health", 10) * DZModule.Settings.BossDifficultyMultiplier;
        ...
        protected virtual void StartFight()
        {
            ...
            DZModule.Session.CurrentBossName = GetBossName();
            
            // Change music
            if (DZModule.Settings.EnableBossMusic && !string.IsNullOrEmpty(bossMusic))
            {
        ...
        protected virtual void Defeat()
        {
            ...
            DZModule.Session.BossesDefeated++;
            DZModule.SaveData?.RecordBossDefeat(GetBossName());
