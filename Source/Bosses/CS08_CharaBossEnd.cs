...
#pragma warning restore CS8618
    ...
    private IEnumerator Cutscene(Level level)
    {
        ...
        level2.Session.Audio.Music.Event = "event:/Mods/pusheen/music/lvl8/chara_acoustic";
    ...
    private IEnumerator StartMusic()
    {
        ...
        level.Session.Audio.Music.Event = "event:/Mods/pusheen/music/lvl8/chara_acoustic";
        level.Session.Audio.Apply(false);
        yield return 0.5f;
        yield break;
    }
