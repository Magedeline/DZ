...
public class CS10BossIntro : CutsceneEntity
{
    ...
    private IEnumerator Cutscene(Level level)
    {
        ...
        Audio.SetMusic("event:/Mods/pusheen/ch10/music/boss_wispy_woods");
        ...
        yield return Textbox.Say("DZ_CH10_BOSS_INTRO", OnTreeFaceEmerge, OnTheoReaction);
    ...
    private IEnumerator WispyWoodsAppears(Level level)
    {
        ...
        yield return Textbox.Say("DZ_CH10_BOSS_INTRO_WISPY", OnWispyThreats);
