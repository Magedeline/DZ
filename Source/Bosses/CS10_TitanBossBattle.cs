namespace Celeste.Cutscenes
{
    ...
    public class CS10_TitanBossBattle : CutsceneEntity
    {
        ...
        private IEnumerator CutsceneSequence(Level level)
        {
            ...
            yield return Textbox.Say("DZ_CH12_TITAN_BOSS_BATTLE_MID");

            // Boss defeated
            level.Flash(Color.Cyan, false);
            yield return 0.5f;
            
            yield return Textbox.Say("DZ_CH12_TITAN_BOSS_DEFEATED");

            // Chapter ending
            yield return Textbox.Say("DZ_CH12_CHAPTER_END");
