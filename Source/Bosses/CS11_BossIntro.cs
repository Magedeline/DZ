...
namespace Celeste.Cutscenes
{
    ...
    public class CS11_BossIntro : CutsceneEntity
    {
        ...
        private const string DIALOG_KEY_INTRO = "DZ_CH11_BOSS_INTRO";
        private const string DIALOG_KEY_WARNING = "DZ_CH11_BOSS_INTRO_DO_NOT_HURT_HER";
        ...
        private const string MUSIC_BOSS_INTRO = "event:/Mods/pusheen/music/lvl11/pmarlet_fight";
        #endregion
