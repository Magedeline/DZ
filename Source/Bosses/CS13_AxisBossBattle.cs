namespace Celeste.Cutscenes
{
    ...
    public class CS13_AxisBossBattle : CutsceneEntity
    {
        ...
        private IEnumerator CutsceneSequence(Level level)
        {
            ...
            yield return Textbox.Say("DZ_CH13_AXIS_APPROACH");

            // Boss introduction
            level.Flash(Color.Red, false);
            level.Shake(1.5f);
            
            yield return Textbox.Say("DZ_CH13_AXIS_BOSS_INTRO");

            // Mid-battle power increase
            yield return 1f;
            level.Shake(2.5f);
            
            yield return Textbox.Say("DZ_CH13_AXIS_BATTLE_MID");

            // Final defeat
            level.Flash(Color.Blue, false);
            yield return 0.5f;
            
            yield return Textbox.Say("DZ_CH13_AXIS_DEFEATED");

            // Chapter ending
            yield return Textbox.Say("DZ_CH13_CHAPTER_END");
