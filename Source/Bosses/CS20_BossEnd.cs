...
namespace Celeste.Cutscenes
{
    ...
    public class CS20_BossEnd : CutsceneEntity
    {
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            yield return Textbox.Say("DZ_CH20_ASRIEL_HYPERGONER_IMPRESSED");

            yield return 0.3f;

            // Part 2: Asriel mocks them
            yield return Textbox.Say("DZ_CH20_ASRIEL_MOCKING_HEROES");
            ...
            Audio.Play("event:/Mods/pusheen/new_content/char/bosses/asriel/Asriel_Segapower01", asriel?.Position ?? player.Position);
            ...
            yield return Textbox.Say("DZ_CH20_ASRIEL_FRACTION_POWER");
            ...
            Audio.Play("event:/Mods/pusheen/new_content/char/bosses/asriel/Asriel_Segapower02", asriel?.Position ?? player.Position);
            ...
            yield return Textbox.Say("DZ_CH20_ASRIEL_ANGEL_TRANSFORMATION");
            ...
            level.Shake(3.0f);
            Audio.Play("event:/Mods/pusheen/new_content/char/bosses/asriel/Asriel_BarrierShatter", asriel?.Position ?? player.Position);
        ...
        public override void OnEnd(Level level)
        {
            ...
            level.Session.Audio.Music.Event = "event:/Mods/pusheen/new_content/music/lvl20/burn_in_despair";
