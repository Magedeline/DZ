namespace Celeste.Cutscenes
{
    ...
    public class CS20_FinalBossDefeat : CutsceneEntity
    {
        ...
        private IEnumerator cutsceneSequence(Level level)
        {
            ...
            yield return Textbox.Say("DZ_CH20_ASRIEL_RESTORATION_START");
            ...
            yield return Textbox.Say("DZ_CH20_ASRIEL_GIVES_LIFE");
            ...
            yield return Textbox.Say("DZ_CH20_MADELINE_AWAKENING");
            ...
            yield return Textbox.Say("DZ_CH20_MADELINE_BADELINE_GRATEFUL");
            
            // Asriel stands
            asrielSprite.Play("idle");
            
            yield return Textbox.Say("DZ_CH20_ASRIEL_RESPONSE");
