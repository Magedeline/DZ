...
[CustomEntity("DZ/ELSTerminaFinalBoss")]
[Tracked(false)]
public class ELSTerminaFinalBoss : Actor
{
    ...
    private void PlayActivate() => PlayAudio("event:/Mods/pusheen/new_content/char/els/Els_Activate");
    private void PlayBeamSlash() => PlayAudio("event:/Mods/pusheen/new_content/char/els/Els_BeamSlash");
    private void PlayBiggerGunFire() => PlayAudio("event:/Mods/pusheen/new_content/char/els/Els_Bigger_Gun_Fire");
    private void PlayBigHit() => PlayAudio("event:/Mods/pusheen/new_content/char/els/big_hit");
    private void PlayBubble() => PlayAudio("event:/Mods/pusheen/new_content/char/els/Els_Bubble");
    private void PlayBuild() => PlayAudio("event:/Mods/pusheen/new_content/char/els/Els_Build");
    private void PlayCharge() => PlayAudio("event:/Mods/pusheen/new_content/char/els/Els_Charge");
    private void PlayConsume() => PlayAudio("event:/Mods/pusheen/new_content/char/els/consume_crystal_heart");
    private void PlayCreate() => PlayAudio("event:/Mods/pusheen/new_content/char/els/create");
    private void PlayCryingDeath() => PlayAudio("event:/Mods/pusheen/new_content/char/els/crying_death");
    private void PlayDarkmatterSpawn() => PlayAudio("event:/Mods/pusheen/new_content/char/els/dark_matter_spawn");
    private void PlayFinalCry() => PlayAudio("event:/Mods/pusheen/new_content/char/els/Els_Final_Cry");
    private void PlayIdle() => PlayAudio("event:/Mods/pusheen/new_content/char/els/idle");
    private void PlayImpact() => PlayAudio("event:/Mods/pusheen/new_content/char/els/impact");
    private void PlayIntro() => PlayAudio("event:/Mods/pusheen/new_content/char/els/Els_Intro");
    private void PlayKnockout() => PlayAudio("event:/Mods/pusheen/new_content/char/els/knockout");
    private void PlayLaugh() => PlayAudio("event:/Mods/pusheen/new_content/char/els/laugh");
    private void PlayPrecreate() => PlayAudio("event:/Mods/pusheen/new_content/char/els/pre_create");
    private void PlayPredeath() => PlayAudio("event:/Mods/pusheen/new_content/char/els/Els_Predeath");
    private void PlayPreImpact() => PlayAudio("event:/Mods/pusheen/new_content/char/els/pre_impact");
    private void PlayRevival() => PlayAudio("event:/Mods/pusheen/new_content/char/els/revival");
    private void PlayRift() => PlayAudio("event:/Mods/pusheen/new_content/char/els/Els_Rift");
    private void PlayRiftBullet() => PlayAudio("event:/Mods/pusheen/new_content/char/els/rift_bullet");
    private void PlayScreamHit() => PlayAudio("event:/Mods/pusheen/new_content/char/els/Els_Scream_Hit");
    private void PlayShellScreamer() => PlayAudio("event:/Mods/pusheen/new_content/char/els/Els_Shell_Screamer");
    private void PlayShellcrack() => PlayAudio("event:/Mods/pusheen/new_content/char/els/shell_crack");
    private void PlaySlice() => PlayAudio("event:/Mods/pusheen/new_content/char/els/Els_Slice");
    private void PlaySpawn() => PlayAudio("event:/Mods/pusheen/new_content/char/els/spawn");
    private void PlayStarDeath() => PlayAudio("event:/Mods/pusheen/new_content/char/els/Els_StarDeath");
    private void PlayStarDeathGlitch() => PlayAudio("event:/Mods/pusheen/new_content/char/els/Els_StarDeath_Glitch");
    private void PlayTeleport() => PlayAudio("event:/Mods/pusheen/new_content/char/els/teleport");
    private void PlayTimeManipulatorEnd() => PlayAudio("event:/Mods/pusheen/new_content/char/els/Els_Time_Manipulator_End");
    private void PlayTimeManipulatorStart() => PlayAudio("event:/Mods/pusheen/new_content/char/els/Els_Time_Manipulator_Start");
    private void PlayWoosh() => PlayAudio("event:/Mods/pusheen/new_content/char/els/woosh");
    #endregion
