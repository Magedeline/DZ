...
internal class BoomBooster : Entity
{
    ...
    : base(((data.Position) + (offset)))
  {
    ...
    this.Add((Component) (this.sprite = global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.SpriteBank.Create("boomBooster")));
  ...
  private void OnPlayer(Player player)
  {
    ...
    this.hasDestroyDash = global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.hasDestroyDash;
  ...
  public void PlayerBoosted(Player player, Vector2 direction)
  {
    ...
    this.wiggler.Stop();
    global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.hasDestroyDash = this.hasDestroyDash;
    global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.destroyDashActive = false;
  }
