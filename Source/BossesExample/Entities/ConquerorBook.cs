...
internal class ConquerorBook : CutsceneEntity
{
  ...
  private class ConquerorPage : Entity
  {
    ...
    public ConquerorPage(string imageKey, bool isTomb, bool noSound, ConquerorBook book)
    {
      ...
      {
        imageKey = "";
        if (global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.Settings.ResetKeysForSession)
        {
        ...
        {
          if (global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.SaveData.StoneFlags.Contains("t_key"))
            imageKey += "t";
          if (global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.SaveData.StoneFlags.Contains("f_key"))
            imageKey += "f";
          if (global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.SaveData.StoneFlags.Contains("a_key"))
            imageKey += "a";
        }
