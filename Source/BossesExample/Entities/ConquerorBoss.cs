...
public class ConquerorBoss : Actor
{
  ...
  public override void Added(Scene scene)
  {
    ...
    if (this.Phase == 4)
    {
      global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.InitPlayerHealth(3);
  ...
  public void PlayerTakeDamage(Player player)
  {
    ...
    {
      if (global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.destroyDashActive || (double) this.playerDamageCooldown > 0.0 || SaveData.Instance.Assists.Invincible)
        return;
      this.playerDamageCooldown = 1f;
      bool flag = global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.DecreasePlayerHealth(player, this);
      this.level.Shake(0.3f);
      Input.Rumble((RumbleStrength) 2, (RumbleLength) 2);
