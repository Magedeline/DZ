...
// Type: global::Celeste.Mod.ricky06ModPack.Entities.ConquerorHealth
...
internal class ConquerorHealth : Entity
{
  ...
  {
    this.Add((Component) (this.baseBar = global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.GuiBank.Create("bossBaseBar")));
  ...
  private class HealthSlice : Entity
  {
    ...
    {
      this.Add((Component) (this.slice = global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.GuiBank.Create(tag)));
      this.Tag = ((int) (Tags.HUD));
    }
