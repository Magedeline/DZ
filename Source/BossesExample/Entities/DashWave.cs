...
// Type: global::Celeste.Mod.ricky06ModPack.Entities.DashWave
...
public class DashWave : Entity
{
  ...
  public DashWave(Player player)
    : base(Vector2.Zero)
  {
    this.Add((Component) (this.sprite = global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.SpriteBank.Create("dash_wave")));
  ...
  {
    base.Update();
    if (global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.hasDestroyDash)
      this.Visible = true;
    else
      this.Visible = false;
