...
// Type: global::Celeste.Mod.ricky06ModPack.Entities.DestroySpinnerRefill
...
internal class DestroySpinnerRefill : Entity
{
    ...
    : base(position)
  {
    ...
    this.Add((Component) (this.sprite = global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.SpriteBank.Create("destroy_refill")));
  ...
  public override void Update()
  {
    ...
    {
      Logger.Log(LogLevel.Error, "DZ", $"DestroySpinnerRefill.Update error: {ex}");
    }
  ...
  {
    if (!player.UseRefill(this.twoDashes) && global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.hasDestroyDash)
      return;
    ...
    global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.hasDestroyDash = true;
    if (global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.dw == null)
    {
      global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.dw = new DashWave(player);
      ((Scene) this.level).Add((Entity) global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.dw);
    }
  }
