...
public class DestructableSpinner : Entity
{
    ...
    : base(((data.Position) + (offset)))
  {
    ...
    if (global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.noResetDict.ContainsKey((Entity) this))
      return;
    global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.noResetDict.Add((Entity) this, new EntityID(data.Level.Name, data.ID));
  }
  ...
  {
    if (global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.destroyDashActive)
      this.Destroy();
    else
