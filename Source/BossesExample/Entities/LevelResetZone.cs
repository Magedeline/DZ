...
internal class LevelResetZone : SeekerBarrier
{
  ...
  public void ResetLevel(string roomID, string audioID)
  {
    ...
    ((Scene) level).OnEndOfFrame += (Action) (() =>
    {
      ...
      bool hasDestroyDash = global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.hasDestroyDash;
      bool destroyDashActive = global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.destroyDashActive;
        ...
        if (entity.startedMoving)
        {
          foreach (StaticMover component in ((Entity) player).Scene.Tracker.GetComponents<StaticMover>())
          {
            if (component.IsRiding((Solid) entity))
            {
              ...
              try
              {
                level.Session.DoNotLoad.Add(global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.noResetDict[((Component) component).Entity]);
              }
              catch
              {
      ...
      global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.lrzTransition = true;
      ...
      global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.hasDestroyDash = hasDestroyDash;
      global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.destroyDashActive = destroyDashActive;
        ...
        if (entity.startedMoving)
        {
          foreach (StaticMover component in ((Entity) player).Scene.Tracker.GetComponents<StaticMover>())
          {
            if (component.IsRiding((Solid) entity))
            {
              ...
              try
              {
                level.Session.DoNotLoad.Remove(global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.noResetDict[((Component) component).Entity]);
              }
              catch
              {
              }
      ...
      global::Celeste.Mod.DZ.BossesExample.BossesExampleModule.lrzTransition = false;
