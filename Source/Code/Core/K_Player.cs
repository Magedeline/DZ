...
#pragma warning restore CL0008
    {
        ...
        {
            // Character - Madeline (Kirby skin) — via SoundBank
            public const string char_mad_footstep             = SoundBank.Char.Kirby.Footstep;
            public const string char_mad_handhold             = SoundBank.Char.Kirby.Handhold;
            public const string char_mad_campfire_stand       = SoundBank.Char.Kirby.CampfireStand;
            public const string char_mad_summit_sit           = SoundBank.Char.Kirby.SummitSit;
            public const string char_mad_idle_scratch         = SoundBank.Char.Kirby.IdleScratch;
            public const string char_mad_idle_sneeze          = SoundBank.Char.Kirby.IdleSneeze;
            public const string char_mad_idle_crackknuckles   = SoundBank.Char.Kirby.IdleCrackKnuckles;
            public const string char_mad_jump                 = SoundBank.Char.Kirby.Jump;
            public const string char_mad_jump_assisted        = SoundBank.Char.Kirby.JumpAssisted;
            public const string char_mad_jump_dreamblock      = SoundBank.Char.Kirby.JumpDreamblock;
            public const string char_mad_jump_super           = SoundBank.Char.Kirby.JumpSuper;
            public const string char_mad_jump_superslide      = SoundBank.Char.Kirby.JumpSuperslide;
            public const string char_mad_jump_superwall       = SoundBank.Char.Kirby.JumpSuperwall;
            public const string char_mad_jump_wall_left       = SoundBank.Char.Kirby.JumpWallLeft;
            public const string char_mad_jump_wall_right      = SoundBank.Char.Kirby.JumpWallRight;
            public const string char_mad_jump_climb_left      = SoundBank.Char.Kirby.JumpClimbLeft;
            public const string char_mad_jump_climb_right     = SoundBank.Char.Kirby.JumpClimbRight;
            public const string char_mad_land                 = SoundBank.Char.Kirby.Landing; // GUIDs.txt: kirby/landing
            public const string char_mad_grab                 = SoundBank.Char.Kirby.Grab;
            public const string char_mad_grab_letgo           = SoundBank.Char.Kirby.GrabLetgo;
            public const string char_mad_climb_ledge          = SoundBank.Char.Kirby.ClimbLedge;
            public const string char_mad_wallslide            = SoundBank.Char.Kirby.Wallslide;
            public const string char_mad_dash_red_right       = SoundBank.Char.Kirby.DashRedRight;
            public const string char_mad_dash_red_left        = SoundBank.Char.Kirby.DashRedLeft;
            public const string char_mad_dash_pink_right      = SoundBank.Char.Kirby.DashPinkRight;
            public const string char_mad_dash_pink_left       = SoundBank.Char.Kirby.DashPinkLeft;
            public const string char_mad_duck                 = SoundBank.Char.Kirby.Duck;
            public const string char_mad_stand                = SoundBank.Char.Kirby.Stand;
            public const string char_mad_water_dash_gen       = SoundBank.Char.Kirby.WaterDashGen;
            public const string char_mad_water_move_shallow   = SoundBank.Char.Kirby.WaterMoveShallow;
            public const string char_mad_dreamblock_enter     = SoundBank.Char.Kirby.DreamblockEnter;
            public const string char_mad_dreamblock_exit      = SoundBank.Char.Kirby.DreamblockExit;
            public const string char_mad_dreamblock_travel    = SoundBank.Char.Kirby.DreamblockTravel;
            public const string char_mad_revive               = SoundBank.Char.Kirby.Revive;
            public const string char_mad_mirrortemple_landing = SoundBank.Char.Kirby.MirrorTempleBigLanding;
            public const string char_mad_summit_areastart     = SoundBank.Char.Kirby.SummitAreaStart;
            public const string char_mad_crystaltheo_lift     = SoundBank.Char.Kirby.CrystalTheoLift;  // GUIDs.txt: crystaltheo_lift
            public const string char_mad_crystaltheo_throw    = SoundBank.Char.Kirby.CrystalTheoThrow; // GUIDs.txt: crystaltheo_throw

            // Game
            public const string game_06_feather_state_bump    = SoundBank.Game.Ch08_Edge.FeatherStateBump;
            public const string game_06_feather_state_end     = SoundBank.Game.Ch08_Edge.FeatherStateEnd;
            public const string game_06_feather_state_loop    = SoundBank.Game.Ch08_Edge.FeatherStateLoop;
            public const string game_06_feather_state_warning = SoundBank.Game.Ch08_Edge.FeatherStateWarning;
            public const string game_09_conveyor_activate     = SoundBank.Game.Ch18_Core.ConveyorActivate;
            public const string game_assist_dreamblockbounce  = SoundBank.Game.General.AssistDreamblockBounce;

            // Music
            public const string music_reflection_main = SoundBank.Music.Lvl8.Main;
...
#pragma warning restore CL013
        ...
        private void AirDriftBegin()
        {
            ...
            if (level != null)
            {
                ...
                Audio.Play("event:/char/pusheen/kirby/dash_charge", Position); // TODO: add to FMOD bank & SoundBank.Char.Kirby
            }
        }
        ...
        private void StarShotBegin()
        {
            ...
            if (level != null)
                Audio.Play("event:/char/pusheen/kirby/inhale_start", Position); // TODO: add to FMOD bank & SoundBank.Char.Kirby
        }
        ...
        private void SlideTackleBegin()
        {
            ...
            if (level != null)
            {
                ...
                level.Shake(0.1f);
                Audio.Play("event:/char/pusheen/kirby/kirby_knight/punch_A", Position); // TODO: add kirby_knight/* sub-bank to FMOD & SoundBank
            }
        }
