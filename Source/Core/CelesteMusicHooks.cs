...
public static class CelesteMusicHooks
{
    ...
    public static void Load()
    {
        ...
        Logger.Log(LogLevel.Info, "DZ", "CelesteMusicHooks loaded with On.hook and IL.hook support");
    }
    ...
    public static void Unload()
    {
        ...
        Logger.Log(LogLevel.Info, "DZ", "CelesteMusicHooks unloaded (On.hook and IL.hook)");
    }
    ...
    private static void OnAudioSetMusicParam(On.Celeste.Audio.orig_SetMusicParam orig, string param, float value)
    {
        ...
        catch (EntryPointNotFoundException)
        {
            ...
            Logger.Log(LogLevel.Warn, "DZ/MusicHooks",
