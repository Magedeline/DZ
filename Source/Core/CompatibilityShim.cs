...
namespace DZ
{
    ...
    public static class LuaCutsceneManager
    {
        ...
        public static void CallLuaFunction(string command)
        {
            ...
            Logger.Log(LogLevel.Info, "DZ", $"LuaCutsceneManager compatibility call: {command}");
        }
    }
    ...
    public static class AtlasPathHelper
    {
        ...
        private static IEnumerable<string> GetCandidates(string path)
        {
            ...
            string alternatePath = ToggleDZSegment(path);
        ...
        private static string ToggleDZSegment(string path)
        {
            string normalizedPath = NormalizePath(path);
            ...
            if (string.Equals(updatedParts[1], "DZ", StringComparison.OrdinalIgnoreCase))
            {
                updatedParts.RemoveAt(1);
            }
            else
            {
                updatedParts.Insert(1, "DZ");
            }
    ...
    public static class DZSaveFacade
    {
        ...
        public static bool HasModSave => DZModule.SaveData != null;
        ...
        public static void UnlockChapter(string sid)
        {
            ...
            {
                DZModule.SaveData?.UnlockedModes.Add(ChapterUnlockPrefix + sid);
            }
        }
        ...
        public static bool IsChapterUnlocked(string sid)
        {
            return !string.IsNullOrWhiteSpace(sid)
                && DZModule.SaveData?.UnlockedModes.Contains(ChapterUnlockPrefix + sid) == true;
        }
        ...
        public static void TryRecordExtendedHeartGem(Session session)
        {
            ...
            {
                DZModule.SaveData?.CollectHeartGem(BuildExtendedHeartId(sid, (int)session.Area.Mode));
            }
        }
    ...
    public static class DZProgressionManager
    {
        ...
        public static void RecordCheckpoint(Level level, Vector2 checkpoint, string checkpointId)
        {
            ...
            if (!string.IsNullOrEmpty(checkpointId))
            {
                ...
                DZModule.SaveData?.UnlockAchievement($"checkpoint:{level.Session.Area.SID}:{checkpointId}");
            }
        }
        ...
        public static void RecordMiniHeart(Level level, string gemId)
        {
            ...
            {
                DZModule.SaveData?.UnlockAchievement($"mini_heart:{level.Session.Area.SID}:{gemId}");
            }
        }
        ...
        public static void RecordCassette(Level level)
        {
            if (level?.Session != null)
            {
                DZModule.SaveData?.UnlockAchievement($"cassette:{level.Session.Area.SID}");
            }
        }
    }
}
...
#pragma warning restore CS0618
    ...
    /// <summary>
    /// Stub for PlayerInventoryManager - manages player inventory
    /// </summary>
    public static class PlayerInventoryManager
    {
        public static void SetNoRefills(Session session, bool value)
        {
        }

        public static void SetNoDash(Session session, bool value)
        {
        }

        public static void SetNoJump(Session session, bool value)
        {
        }

        public static void SetNoGrab(Session session, bool value)
        {
        }

        public static void SetNoWallJump(Session session, bool value)
        {
        }

        public static void SetNoClimb(Session session, bool value)
        {
        }

        public static void SetNoHover(Session session, bool value)
        {
        }

        public static void EnableHeartPower(Level level, bool value = true)
        {
        }

        public static void EnableKirbyPlayer(Level level, bool value = true)
        {
        }

        public static void EnableSayGoodbye(Level level, bool value = true)
        {
        }

        public static void EnableTitanTowerClimbing(Level level, bool value = true)
        {
        }

        public static void EnableCorruption(Level level, bool value = true)
        {
        }

        public static void EnableTheEnd(Level level, bool value = true)
        {
        }
    ...
    /// <summary>
    /// Stub for DZProgressionManager - manages DZ mod progression
    /// </summary>
    public static class DZProgressionManager
    {
        public static void RegisterHeartGem(Session session, string sid)
        {
        }

        public static void RegisterTape(Session session, string sid)
        {
        }

        public static void RegisterBerry(Session session, string sid)
        {
        }
        ...
        public static void RecordMiniHeart(Level level, string sid)
        {
        }
