...
///    <c>Graphics/Atlases/Gui/DZ/mastery/asriel_iso_bg.png</c> is
///    rendered behind the chapter panel card, blending in as a cosmic "100%"
///    completion reward.
///
/// <para>
/// Art assets needed (place in <c>Graphics/Atlases/Gui/DZ/mastery/</c>):
/// <list type="bullet">
...
public static class CosmicChapterPanelHook
{
    ...
    private const string MasteryBgTexPath = "DZ/mastery/asriel_iso_bg";
    ...
    public static void Load()
    {
        ...
        Logger.Log(LogLevel.Info, "DZ", "CosmicChapterPanelHook loaded");
    }
    ...
    public static void Unload()
    {
        ...
        Logger.Log(LogLevel.Info, "DZ", "CosmicChapterPanelHook unloaded");
    }
        ...
        OuiChapterPanel self)
    {
        ...
        bool hasMastery = global::Celeste.Mod.DZ.DZModule.SaveData?.HasFullMastery(self.Area.SID) ?? false;
