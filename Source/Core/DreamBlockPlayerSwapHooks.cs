...
namespace DZ
{
    ...
    internal static class DreamBlockPlayerSwapHooks
    {
        ...
        private const string PreEnterSpriteModeKey  = "DZ_DreamSwap_OrigSpriteMode";
        private const string PreEnterKirbyActiveKey = "DZ_DreamSwap_OrigKirbyActive";

        // Manual hook reference — must be kept alive to avoid GC disposal
        // Manual hook reference — must be kept alive to avoid GC disposal
        private static Hook dreamDashBeginHook;

        // Guard flag to prevent double loading
        ...
        internal static void Load()
        {
            ...
            isLoaded = true;
            Logger.Log(LogLevel.Info, "DZ", "[DreamBlockPlayerSwap] Hooks loaded");
        }
        ...
        internal static void Unload()
        {
            ...
            On.Celeste.DreamBlock.OnPlayerExit -= OnDreamBlockExit;
            isLoaded = false;
            Logger.Log(LogLevel.Info, "DZ", "[DreamBlockPlayerSwap] Hooks unloaded");
        }
        ...
        private static void SwapToKirby(global::Celeste.Player player, global::Celeste.Mod.DZ.DZModuleSession session)
        {
        ...
        private static void SwapToMadeline(global::Celeste.Player player, global::Celeste.Mod.DZ.DZModuleSession session)
        {
