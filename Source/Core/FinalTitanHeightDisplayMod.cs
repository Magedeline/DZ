namespace DZ
{
    ...
    public class FinalTitanHeightDisplayMod : Entity
    {
        ...
        private void stepAudioProgression()
        {
            ...
            if (progress < 12)
            {
                session.Audio.Music.Event = "event:/Mods/pusheen/new_content/music/lvl20/climb";
                session.Audio.Music.Progress = progress;
            }
            else
            {
                session.Audio.Music.Event = "event:/Mods/pusheen/new_content/music/lvl20/final_titan";
            }
