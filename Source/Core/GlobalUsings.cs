...
global using Util = Celeste.Mod.DZ.Util;
global using CustomSFX = Celeste.Mod.DZ.CustomSFX;
...
// Type aliases
// global using static Celeste.PlayerSpriteModeExtensions; // TODO: Create this extension class
global using KirbyModeExt = Celeste.Extensions.KirbyMode;
global using DZModule = Celeste.Mod.DZ.DZModule;
// global using DZModuleSettings = Celeste.Mod.DZ.DZModuleSettings; // Duplicate definition
// global using DZModuleSaveData = Celeste.Mod.DZ.DZModuleSaveData; // Duplicate definition
// global using DZModuleSession = Celeste.Mod.DZ.DZModuleSession; // Duplicate definition
global using IngesteModule = Celeste.Mod.DZ.DZModule;
global using IngesteLogger = Celeste.Helpers.IngesteLogger;
// global using IngesteModuleSettings = Celeste.Mod.DZ.DZModuleSettings; // Duplicate
// global using MaggySaveDataMigration = Celeste.Helpers.MaggySaveDataMigration; // TODO: Create this class
