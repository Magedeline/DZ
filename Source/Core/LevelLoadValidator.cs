...
namespace Celeste.Mod.DZ
{
    ...
    public static class LevelLoadValidator
    {
        ...
        public static void Initialize()
        {
            ...
            {
                Logger.Log(LogLevel.Warn, "DZ/LevelValidator", $"Could not pre-load dialog keys: {ex.Message}");
            }

            Logger.Log(LogLevel.Info, "DZ/LevelValidator", $"Level validator initialized with {_knownDialogKeys.Count} known dialog keys");
        }
        ...
        public static void ValidateLevel(Level level)
        {
            ...
            double elapsed = PerformanceProfiler.Profile("LevelLoadValidator.ValidateLevel", () =>
            {
                ...
                if (warnings > 0)
                {
                    Logger.Log(LogLevel.Warn, "DZ/LevelValidator",
        ...
        private static int ValidateDialogTrigger(Entity entity, string levelName)
        {
            ...
            {
                Logger.Log(LogLevel.Debug, "DZ/LevelValidator",
