namespace DZ
{
    ...
    internal static class IngesteConstants
    {
        ...
        {
            public const string ANCIENT_SWITCH = "DZ/AncientSwitch";
            public const string SESSION_FLAG_TRIGGER = "DZ/SessionFlagTrigger";
            public const string SAMPLE_TRIGGER = "DZ/SampleTrigger";
        }
    }
}
