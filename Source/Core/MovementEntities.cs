...
namespace DZ
{
    ...
    // =============================================
    [CustomEntity("DZ/GravityFlipPlatform")]
    [Tracked]
    public class GravityFlipPlatform : Solid
    {
            ...
            : base(data.Position + offset, data.Width, data.Height, safe: true)
        {
            ...
            Add(sprite = GFX.SpriteBank.Create("DZ_gravityFlipPlatform"));
    ...
    public class PortalDoor : Entity
    {
            ...
            : base(data.Position + offset)
        {
            ...
            Add(sprite = GFX.SpriteBank.Create("DZ_portalDoor"));
        }
    ...
    public class LaunchCannon : Entity
    {
            ...
            : base(data.Position + offset)
        {
            ...
            Add(sprite = GFX.SpriteBank.Create("DZ_launchCannon"));
        }
