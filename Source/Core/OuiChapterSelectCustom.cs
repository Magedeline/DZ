...
public static class OuiChapterSelectCustom
{
    ...
    public static void Load()
    {
        ...
        Logger.Log(LogLevel.Info, "DZ", "[OuiChapterSelectCustom] Loaded");
    }
    ...
    public static void Unload()
    {
        ...
        Logger.Log(LogLevel.Info, "DZ", "[OuiChapterSelectCustom] Unloaded");
    }
        ...
        Oui from)
    {
        ...
        Logger.Log(LogLevel.Info, "DZ", "[OuiChapterSelectCustom] Chapter select fully loaded");
    }
