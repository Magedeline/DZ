    ...
    public static class SaveDataExtensions
    {
        public static bool IsDeltaBerryCollected(string id)
        {
            if (string.IsNullOrEmpty(id))
                return false;
            return global::Celeste.Mod.DZ.DZModule.SaveData?.CollectedPopstarBerries?.Contains(id) == true;
        }
        ...
        public static void MarkDeltaBerryAsCollected(string id)
        {
            if (string.IsNullOrEmpty(id))
                return;
            global::Celeste.Mod.DZ.DZModule.SaveData?.CollectedPopstarBerries?.Add(id);
        }

        public static void ClearDeltaBerries()
        {
            global::Celeste.Mod.DZ.DZModule.SaveData?.CollectedPopstarBerries?.Clear();
        }
    }
}
