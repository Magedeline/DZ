...
namespace DZ
{
    [CustomEntity(new string[] { "DZ/WaveFazeSlammerTutorialMachine", "DZ/WaveFazeSlammerMachine" })]
    [HotReloadable]
    public class WaveFazeSlammerTutorialMachine : JumpThru
    {
        ...
        private WaveFazeSlammerPresentation presentation;
        ...
        public WaveFazeSlammerTutorialMachine(Vector2 position)
            : base(position, 88, safe: true)
        {
            ...
            {
                Logger.Log(LogLevel.Warn, "WaveFazeSlammerTutorialMachine", $"Missing texture: {backPath}");
            }
            ...
            {
                Logger.Log(LogLevel.Warn, "WaveFazeSlammerTutorialMachine", $"Missing texture: {noisePath}00");
            }
            ...
            {
                Logger.Log(LogLevel.Warn, "WaveFazeSlammerTutorialMachine", $"Missing texture: {frontLeftPath}");
            }
        ...
        public WaveFazeSlammerTutorialMachine(EntityData data, Vector2 position)
        ...
        public override void Added(Scene scene)
        {
            ...
            {
                Logger.Log(LogLevel.Warn, "WaveFazeSlammerTutorialMachine", $"Missing texture: {frontRightPath}");
            }
            ...
            {
                Logger.Log(LogLevel.Warn, "WaveFazeSlammerTutorialMachine", $"Missing texture: {neonPath}00");
            }
        ...
        public override void Render()
        {
            ...
            {
                Draw.Rect(Position.X - 44f, Position.Y - 60f, 88f, 60f, Color.Orange * 0.5f);
