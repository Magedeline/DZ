...
namespace Celeste.Cutscenes
{
  ...
  public class Cs02DreamingPhonecallPortal : CutsceneEntity
  {
    ...
    private IEnumerator cutscene(Level level)
    {
      ...
      this.Add(tween);
      Audio.Play("event:/desolozantas/game/02_nightmare/sequence_phone_portal", payphone.Position);
    ...
    public override void OnEnd(Level level)
    {
      ...
      level.Session.Audio.Music.Event = "event:/desolozantas/music/lvl2/awake";
      level.Session.Audio.Ambience.Event = "event:/desolozantas/env/02_awake";
