...
namespace Celeste.Cutscenes
{
    ...
    public class CS02_CharaMirror : CutsceneEntity
    {
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            cs02CharaMirror.sfx.Play("event:/Mods/pusheen/music/lvl2/dreamblock_sting_pt1");
        ...
        private IEnumerator DummyDashTo(float targetX)
        {
            ...
            Audio.Play("event:/Mods/pusheen/char/kirby/dash_pink_right", player.Position);
        ...
        public override void OnEnd(Level level)
        {
            ...
            level.Session.Audio.Music.Event = "event:/Mods/pusheen/music/lvl2/mirror";
