...
namespace Celeste.Cutscenes
{
    ...
    /// </summary>
    [HotReloadable]
    public class Cs03OutroVignette : DesoloZantasVignette
    {
        ...
        private EventInstance? outroMusic;
        ...
        private IEnumerator outroSequence()
        {
            ...
            // Play outro music
            outroMusic = Audio.Play("event:/Mods/pusheen/music/lvl3/outro");
            yield return 1f;
            ...
            var outroTextbox = new Textbox("DZ_CH3_POSTCARD_OUTRO");
        ...
        private void stopSfx()
        {
            ...
            outroMusic?.stop(STOP_MODE.IMMEDIATE);
        }
    }
}
