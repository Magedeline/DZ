...
namespace Celeste.Cutscenes {
    ...
    class Cs04LegendVignette : DesoloZantasVignette {
        ...
        private readonly string[] legendParts = {
            "DZ_CH4_LEGEND_A",    // The void and broken star warrior
            "DZ_CH4_LEGEND_B",    // The FALL and El's emergence
            "DZ_CH4_LEGEND_C",    // Six heroes and star warrior
            "DZ_CH4_LEGEND_D",    // The Desolo Zantas
            "DZ_CH4_LEGEND_E",    // Banishment to the void
        ...
        private IEnumerator legendSequence() {
            ...
            legendMusic = Audio.Play("event:/DZ/music/lvl4/legend");
            yield return 2f;
