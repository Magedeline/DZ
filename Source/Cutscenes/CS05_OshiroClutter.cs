...
public class CS05_OshiroClutter : CutsceneEntity
{
    ...
    private IEnumerator Cutscene(Level level)
    {
        ...
        if (index < 3)
        {
            ...
            yield return Textbox.Say("DZ_CH5_OSHIRO_CLUTTER" + index, Collapse, oshiro.PaceLeft, oshiro.PaceRight);
        ...
        else
        {
            ...
            yield return Textbox.Say("DZ_CH5_OSHIRO_CLUTTER_ENDING");
    ...
    private void SetMusic()
    {
        ...
        obj.Session.Audio.Music.Event = "event:/DZ/music/lvl5/clean";
    ...
    public override void OnEnd(Level level)
    {
        ...
        {
            (oshiro.Sprite as DZOshiroSprite).Pop("idle", flip: true);
        }
        if (index < 3)
        {
            level.Session.SetFlag("oshiro_clutter_door_open");
