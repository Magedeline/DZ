...
namespace Celeste.Cutscenes
{
    public class CS05_OshiroRooftop(CelesteNPC oshiro) : CutsceneEntity
    {
        ...
        private IEnumerator KirbyWalkAway()
        {
            ...
            yield return 0.2f;
            Audio.Play("event:/Mods/pusheen/game/05_restore/suite_bad_moveroof", chara.Position);
        ...
        private void SetChaseMusic()
        {
            ...
            level.Session.Audio.Music.Event = "event:/Mods/pusheen/music/lvl5/oshiro_chase";
