...
namespace Celeste.Cutscenes
{
	...
	public class CS06_Gondola : CutsceneEntity
	{
		...
		private IEnumerator Cutscene()
		{
			...
			Audio.SetMusic("event:/desolozantas/music/lvl1/magolor", true, true);
		...
		private IEnumerator PullLever()
		{
			...
			tween.OnUpdate = delegate(Tween t)
			{
				if (Audio.CurrentMusic == "event:/desolozantas/music/lvl1/magolor")
				{
		...
		{
			Audio.SetMusic("event:/desolozantas/music/lvl6/minigame", true, true);
		...
		private IEnumerator CantBreath()
		{
			this.Level.Shake(0.3f);
			Input.Rumble(RumbleStrength.Strong, RumbleLength.Medium);
			Audio.Play("event:/desolozantas/game/06_stronghold/gondola_scaryvines_03", this.gondola.Position);
