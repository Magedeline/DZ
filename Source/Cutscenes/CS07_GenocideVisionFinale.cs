...
namespace Celeste.Cutscenes
{
    ...
    {
        private const string MainCharaRevealMusicEvent = "event:/Mods/pusheen/music/lvl7/him";
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            yield return Textbox.Say("DZ_CH7_GENO_KIRBY_BADELINE_PANIC");
            ...
            Audio.Play("event:/Mods/pusheen/game/08_edge/chara_heartgem_slice", kirbyTarget);
