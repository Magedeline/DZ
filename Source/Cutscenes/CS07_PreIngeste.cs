...
public class Cs07PreIngeste : CutsceneEntity
{
    ...
    private IEnumerator Cutscene(Level level)
    {
        ...
        yield return Textbox.Say("DZ_CH7_PRE_INGESTE_0");
        yield return 0.3f;

        yield return Textbox.Say("DZ_CH7_PRE_INGESTE_1");
        yield return 0.3f;

        yield return Textbox.Say("DZ_CH7_PRE_INGESTE_2");
        yield return 0.3f;

        yield return Textbox.Say("DZ_CH7_PRE_INGESTE_3");
