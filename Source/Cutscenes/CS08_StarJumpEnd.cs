...
namespace Celeste.Cutscenes
{
    public class CS08_StarJumpEnd : CutsceneEntity
    {
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            yield return Textbox.Say("DZ_CH8_TRUTH_DREAMING", new Func<IEnumerator>[]
            {
            ...
            Audio.Play("event:/Mods/pusheen/game/08_edge/chara_pull_whooshdown");
            ...
            Audio.Play("event:/Mods/pusheen/game/08_edge/chara_pull_impact");
            ...
            this.shakingLoopSfx.Play("event:/Mods/pusheen/game/08_edge/chara_pull_rumble_loop", null, 0f);
            yield return Textbox.Say("DZ_CH8_WATCHOUT", new Func<IEnumerator>[0]);
            Audio.Play("event:/Mods/pusheen/game/08_edge/chara_pull_cliffbreak");
        ...
        {
            Input.Rumble(RumbleStrength.Strong, RumbleLength.Medium);
            Audio.Play("event:/Mods/pusheen/game/08_edge/chara_freakout_1");
        ...
        {
            Input.Rumble(RumbleStrength.Strong, RumbleLength.Medium);
            Audio.Play("event:/Mods/pusheen/game/08_edge/chara_freakout_2");
            this.Level.Shake(0.3f);
            this.anxietyFade += 0.1f;
        ...
        {
            Input.Rumble(RumbleStrength.Strong, RumbleLength.Medium);
            Audio.Play("event:/Mods/pusheen/game/08_edge/chara_freakout_3");
        ...
        private IEnumerator VinesAppearEvenMore()
        {
            ...
            Audio.Play("event:/Mods/pusheen/game/08_edge/chara_freakout_4");
        ...
        {
            Input.Rumble(RumbleStrength.Strong, RumbleLength.Long);
            Audio.Play("event:/Mods/pusheen/game/08_edge/chara_freakout_5");
            this.Level.Shake(1f);
        ...
        private IEnumerator VinesGrabMadeline()
        {
            ...
            Audio.Play("event:/Mods/pusheen/game/08_edge/chara_freakout_6");
        ...
        private IEnumerator BreakHeartMinigame()
        {
            ...
            this.Level.Shake(0.4f);
            Input.Rumble(RumbleStrength.Strong, RumbleLength.Medium);
            Audio.Play("event:/Mods/pusheen/new_content/char/bosses/els/consume_crystal_heart");
        ...
        public override void OnEnd(Level level)
        {
            ...
            if (this.WasSkipped)
            {
                level.OnEndOfFrame += delegate()
                {
                    ...
                    FallEffects.Show(false);
                    level.Session.Audio.Music.Event = "event:/Mods/pusheen/Music/lvl8/main";
                    level.Session.Audio.Apply(false);
                };
                return;
            }
