...
public class CS10IndoorIntro : CutsceneEntity
{
    ...
    private IEnumerator Cutscene(Level level)
    {
        ...
        Audio.SetMusic("event:/DZ/music/lvl10/home");
        ...
        yield return Textbox.Say("DZ_CH10_INDOOR_INTRO", ExamineButterscotchPie, ExamineAsgore, ExamineAsriel);
        ...
        {
            yield return Textbox.Say("DZ_CH10_INDOOR_A", OnExamineButterscotchPie);
        }
        ...
        {
            yield return Textbox.Say("DZ_CH10_INDOOR_B", OnExamineAsgoreT);
        }
        ...
        {
            yield return Textbox.Say("DZ_CH10_INDOOR_C", OnExamineAsrielPlushie);
        }

        yield return 0.8f;

        // Pre-meeting setup
        yield return Textbox.Say("DZ_CH10_INDOOR_PREMEETING", PrepareForMeeting);

        yield return 0.5f;

        // Main meeting with Toriel
        yield return Textbox.Say("DZ_CH10_INDOOR_MEETING", MeetToriel, OnMeetingComplete);
    ...
    private IEnumerator OnExamineAsgoreT()
    {
        ...
        if (player != null)
        {
            ...
            Audio.Play("event:/DZ/char/kirby/laugh");
        }
        yield return 1.2f;
        if (player != null)
        {
