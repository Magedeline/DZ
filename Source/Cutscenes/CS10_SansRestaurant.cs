namespace Celeste.Cutscenes
{
    ...
    public class CS10_SansRestaurant : CutsceneEntity
    {
        ...
        private IEnumerator CutsceneSequence(Level level)
        {
            ...
            yield return Textbox.Say("DZ_CH12_SANS");

            // Food ordering sequence
            yield return 0.5f;
            Audio.Play("event:/game/general/touchswitch_any");

            yield return Textbox.Say("DZ_CH12_ORDERUP");

            // Bad food reaction effects
            level.Shake(0.3f);
            yield return 0.5f;

            yield return Textbox.Say("DZ_CH12_ORDERUP_END");

            // Madeline and Kirby private conversation
            yield return Textbox.Say("DZ_CH12_MADELINE_AND_KIRBY");
