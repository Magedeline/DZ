namespace Celeste.Cutscenes
{
    ...
    public class CS10_TitanTowerApproach : CutsceneEntity
    {
        ...
        private IEnumerator CutsceneSequence(Level level)
        {
            ...
            yield return Textbox.Say("DZ_CH12_TITAN_TOWER_APPROACH");

            // Climbing sequence
            yield return Textbox.Say("DZ_CH12_TITAN_TOWER_CLIMBING_START");

            // Mid-climb warnings
            yield return 0.5f;
            Audio.Play("event:/game/general/strawberry_pulse");
            
            yield return Textbox.Say("DZ_CH12_TITAN_TOWER_MID_CLIMB");

            // Summit approach
            yield return Textbox.Say("DZ_CH12_TITAN_TOWER_SUMMIT_APPROACH");
