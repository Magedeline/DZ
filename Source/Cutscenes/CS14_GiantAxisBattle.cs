namespace Celeste.Cutscenes
{
    ...
    public class CS14_GiantAxisBattle : CutsceneEntity
    {
        ...
        private IEnumerator CutsceneSequence(Level level)
        {
            ...
            yield return Textbox.Say("DZ_CH14_GIANT_AXIS_APPROACH");

            // Battle introduction
            level.Flash(Color.Red, false);
            level.Shake(4.0f);
            
            yield return Textbox.Say("DZ_CH14_GIANT_AXIS_BATTLE_INTRO");

            // Mid-battle power drain
            yield return 1f;
            level.Shake(2.0f);
            
            yield return Textbox.Say("DZ_CH14_GIANT_AXIS_MID_BATTLE");

            // Final phase and defeat
            level.Flash(Color.Red, false);
            yield return 0.5f;
            
            yield return Textbox.Say("DZ_CH14_GIANT_AXIS_FINAL_PHASE");

            // Digital dimension restored
            level.Flash(Color.Cyan, false);
            yield return 0.5f;
            
            yield return Textbox.Say("DZ_CH14_DIGITAL_DIMENSION_RESTORED");

            // Chapter ending
            yield return Textbox.Say("DZ_CH14_CHAPTER_END");
