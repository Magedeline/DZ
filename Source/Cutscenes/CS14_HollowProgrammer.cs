namespace Celeste.Cutscenes
{
    ...
    public class CS14_HollowProgrammer : CutsceneEntity
    {
        ...
        private IEnumerator CutsceneSequence(Level level)
        {
            ...
            yield return Textbox.Say("DZ_CH14_DEDEDE_CORRUPTION_DISCOVERY");

            // Hollow Programmer confrontation
            level.Shake(1.0f);
            level.Flash(Color.Magenta, false);
            
            yield return Textbox.Say("DZ_CH14_HOLLOW_PROGRAMMER_CONFRONTATION");
            ...
            yield return Textbox.Say("DZ_CH14_HOLLOW_PROGRAMMER_BATTLE");

            // Mid-battle restoration attempts
            yield return 0.5f;
            
            yield return Textbox.Say("DZ_CH14_HOLLOW_PROGRAMMER_MID_BATTLE");

            // Final defeat and restoration
            level.Flash(Color.White, false);
            yield return 0.5f;
            
            yield return Textbox.Say("DZ_CH14_HOLLOW_PROGRAMMER_DEFEATED");
