namespace Celeste.Cutscenes
{
    ...
    public class CS15_MountainPeakArrival : CutsceneEntity
    {
        ...
        private IEnumerator CutsceneSequence(Level level)
        {
            ...
            yield return Textbox.Say("DZ_CH15_MOUNTAIN_PEAK_ARRIVAL");

            // Chara's moment of recognition
            yield return 0.5f;
            
            yield return Textbox.Say("DZ_CH15_CHARA_MOMENT");

            // Bridge crossing with mystical effects
            Audio.Play("event:/game/general/strawberry_pulse");
            level.Flash(Color.Purple, false);
            
            yield return Textbox.Say("DZ_CH15_BRIDGE_CROSSING");

            // Castle entrance
            yield return Textbox.Say("DZ_CH15_HOVERING_CASTLE_ENTRANCE");
