namespace Celeste.Cutscenes
{
    ...
    public class CS15_RoaringTitanKingBattle : CutsceneEntity
    {
        ...
        private IEnumerator CutsceneSequence(Level level)
        {
            ...
            yield return Textbox.Say("DZ_CH15_CEREMONY_OF_FLAME");

            // Roaring Titan King battle
            level.Shake(2.0f);
            yield return 1f;
            
            yield return Textbox.Say("DZ_CH15_ROARING_TITAN_KING_BATTLE");

            // Near defeat - emotional moment
            yield return 0.5f;
            
            yield return Textbox.Say("DZ_CH15_ROARING_TITAN_KING_NEAR_DEFEAT");

            // Emotional revelation
            yield return Textbox.Say("DZ_CH15_EMOTIONAL_REVELATION");

            // The first wish granted
            level.Flash(Color.Cyan, false);
            yield return 0.5f;
            
            yield return Textbox.Say("DZ_CH15_THE_FIRST_WISH");
