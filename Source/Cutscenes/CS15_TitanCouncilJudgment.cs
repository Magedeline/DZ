namespace Celeste.Cutscenes
{
    ...
    public class CS15_TitanCouncilJudgment : CutsceneEntity
    {
        ...
        private IEnumerator CutsceneSequence(Level level)
        {
            ...
            yield return Textbox.Say("DZ_CH15_JUDGMENT_CEREMONY");

            // Roaring Titan Council entrance
            level.Shake(1.0f);
            Audio.Play("event:/game/general/strawberry_pulse");
            
            yield return Textbox.Say("DZ_CH15_ROARING_TITAN_COUNCIL_ENTRANCE");

            // Council judgment results
            yield return 0.5f;
            
            yield return Textbox.Say("DZ_CH15_COUNCIL_JUDGMENT_RESULTS");

            // Barrier revelation
            level.Flash(Color.White, false);
            yield return 0.5f;
            
            yield return Textbox.Say("DZ_CH15_BARRIER_REVELATION");
