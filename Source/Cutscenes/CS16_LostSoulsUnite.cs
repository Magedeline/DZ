namespace Celeste.Cutscenes
{
    ...
    public class CS16_LostSoulsUnite : CutsceneEntity
    {
        ...
        private IEnumerator CutsceneSequence(Level level)
        {
            ...
            yield return Textbox.Say("DZ_CH16_LOST_SOULS_CALLING");

            // Calling for help from all friends
            level.Flash(Color.White, false);
            
            yield return Textbox.Say("DZ_CH16_CALLING_FOR_HELP");

            // Eight souls unite
            level.Flash(Color.Cyan, false);
            yield return 1f;
            
            yield return Textbox.Say("DZ_CH16_EIGHT_SOULS_UNITE");
