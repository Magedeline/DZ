namespace Celeste.Cutscenes
{
    ...
    public class CS16_SaveFileBattle : CutsceneEntity
    {
        ...
        private IEnumerator CutsceneSequence(Level level)
        {
            ...
            yield return Textbox.Say("DZ_CH16_SAVE_FILE_CORRUPTION");

            // Save file restoration by lost souls
            level.Flash(Color.White, false);
            yield return 1f;
            
            yield return Textbox.Say("DZ_CH16_SAVE_FILE_RESTORATION");

            // Final confrontation with Els
            level.Shake(5.0f);
            
            yield return Textbox.Say("DZ_CH16_FINAL_CONFRONTATION");
        ...
        private IEnumerator FloweyCirclingTaunt(Level level)
        {
            ...
            yield return Textbox.Say("DZ_CH16_TAKE_THE_L");
        ...
        private IEnumerator CallForHelpSequence(Level level)
        {
            ...
            yield return Textbox.Say("DZ_CH16_YOU_CALL_HELP");
        ...
        private IEnumerator FinalWishSequence(Level level)
        {
            ...
            yield return Textbox.Say("DZ_CH16_FINAL_DEFEAT");
