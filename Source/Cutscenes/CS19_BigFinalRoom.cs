    ...
    public class Cs19BigFinalRoom : CutsceneEntity
    {
        ...
        private IEnumerator cutscene(Level level)
        {
            ...
            if (first)
            {
                ...
                yield return Textbox.Say("DZ_CH19_LAST_ROOM", new Func<IEnumerator>[]
                {
                    NoOpTrigger,
            ...
            else
            {
                ...
                yield return charaAppears();
                yield return Textbox.Say("DZ_CH19_LAST_ROOM_ALT");
                yield return charaVanishes();
                yield return Textbox.Say("DZ_CH19_LAST_ROOM_ALT_2");
                EndCutscene(level);
                yield break;
            }
        ...
        public override void OnEnd(Level level)
        {
            ...
            if (player != null)
            {
                ...
                if (!first && !WasSkipped)
                    Audio.Play("event:/Mods/pusheen/char/kirby/stand", player.Position);
            }
