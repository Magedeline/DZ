...
namespace Celeste.Cutscenes
{
    ...
    public class CS19DZ_CHaraHelps : CutsceneEntity
    {
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            yield return 0.3f;
            yield return Textbox.Say("DZ_CH19_HELPING_HAND", new Func<IEnumerator>[]
            {
        ...
        {
            yield return 0.2f;
            Audio.Play("event:/DZ/new_content/char/kirby/heartbreak", this.player.Position);
        ...
        {
            if (this.Level.Session.Audio.Music.Event != "event:/DZ/new_content/music/lvl19/tape_rooms")
            {
                int num = 0;
