...
namespace Celeste.Cutscenes
{
    ...
    public class CS19_CharaHelps : CutsceneEntity
    {
        ...
        {
            yield return 0.2f;
            Audio.Play("event:/pusheen/final_content/char/kirby/heartbreak", this.player.Position);
        ...
        {
            if (this.Level.Session.Audio.Music.Event != "event:/pusheen/final_content/music/lvl19/tape_room")
            {
                int num = 0;
                ...
                this.Level.Session.Audio.Music.Event = "event:/pusheen/final_content/music/lvl19/tape_room";
