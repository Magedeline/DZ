...
using ScreenWipe = Celeste.ScreenWipe;
using Follower = Celeste.Follower;
using Strawberry = Celeste.Strawberry;
using Textbox = Celeste.Textbox;
using Parallax = Celeste.Parallax;
using FadeWipe = Celeste.FadeWipe;
...
public class CS19_FinalLaunch : CutsceneEntity
{
    ...
    private IEnumerator Cutscene()
    {
        ...
        if (sayDialog)
        {
            yield return Textbox.Say("DZ_CH19_CHARA_LAST_BOOST");
        }
        else
        {
            yield return 0.152f;
