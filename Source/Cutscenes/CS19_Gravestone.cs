...
public class CS19_Gravestone : CutsceneEntity
{
    ...
    private DZ.NPC19_Gravestone gravestone;
    ...
    public CS19_Gravestone(Player player, DZ.NPC19_Gravestone gravestone, Vector2 boostTarget)
    {
        this.player = player;
    ...
    private IEnumerator Cutscene()
    {
        ...
        yield return 0.5f;
        yield return Textbox.Say("DZ_CH19_GRAVESTONE", StepForward, BadelineAppears, SitDown);
        yield return 1f;
