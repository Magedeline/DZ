...
public class CS19_MissTheBird : CutsceneEntity
{
    ...
    private IEnumerator Cutscene(Level level)
    {
        ...
        crashMusicSfx = Audio.Play("event:/Mods/pusheen/new_content/music/lvl19/cinematic/bird_crash_first");
        ...
        yield return Textbox.Say("DZ_CH19_MISS_THE_BIRD", StandUpFaceLeft, TakeStepLeft, TakeStepRight, FlickerBlackhole, OpenBlackhole);
        StartMusic();
        EndCutscene(level);
    }
    ...
    {
        yield return 0.5f;
        Audio.Play("event:/Mods/pusheen/new_content/game/19_spaces/glitch_medium");
        Audio.Play("event:/Mods/pusheen/new_content/music/lvl19/cinematic/els_intro_laugh");
    ...
    private IEnumerator OpenBlackhole()
    {
        ...
        Audio.Play("event:/Mods/pusheen/new_content/music/lvl19/cinematic/els_intro_scream");
        yield return MoonGlitchBackgroundTrigger.GlitchRoutine(1.0f, stayOn: false);
        yield return 2.4f;
        Audio.Play("event:/Mods/pusheen/new_content/game/19_spaces/lightning_strike");
    ...
    {
        Level.Session.Audio.Music.Event = "event:/Mods/pusheen/new_content/music/lvl19/part03";
        Level.Session.Audio.Ambience.Event = "event:/Mods/pusheen/new_content/env/19_voidspiral";
