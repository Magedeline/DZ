...
namespace Celeste.Cutscenes
{
    ...
    public class CS21_EpilogueCredits : CutsceneEntity
    {
        ...
        public override void OnBegin(Level level)
        {
            ...
            {
                DZModule.Session.InCredits = true;
                DZModule.Session.CreditsPhase = 2;
                DZModule.Session.CreditsCompleted = false;
            }

            Audio.SetAmbience(null);
            Audio.SetMusic("event:/Mods/pusheen/music/menu/cast");
        ...
        public override void OnEnd(Level level)
        {
            ...
            if (level.Session.Area.SID == DZModule.Chapter17EpilogueSid)
                DZModule.MarkChapter17EpilogueCompleted();
            else if (DZModule.Session != null)
            {
                DZModule.Session.InCredits = false;
                DZModule.Session.CreditsPhase = 0;
                DZModule.Session.CreditsCompleted = true;
            }
