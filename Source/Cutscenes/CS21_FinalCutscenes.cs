...
namespace Celeste.Cutscenes
{
    ...
    public class CS21_FinalCutscenes : CutsceneEntity
    {
        ...
        // Music
        private const string MUSIC_GOOD_END   = "event:/DZ/music/menu/goodnight";
        private const string MUSIC_NORMAL_END  = "event:/DZ/music/menu/els_win";
        ...
        private IEnumerator NormalEndingSequence(Level level)
        {
            ...
            Audio.Play("event:/DZ/new_content/game/21_desolo_zantas/final_laugh");
            overlayAlpha = 1f;
