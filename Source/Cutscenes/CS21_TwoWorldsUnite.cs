namespace Celeste.Cutscenes
{
    ...
    public class CS21_TwoWorldsUnite : CutsceneEntity
    {
        ...
        private IEnumerator cutsceneSequence(Level level)
        {
            ...
            yield return Textbox.Say("DZ_CH21_HUMAN_HOPE");
            
            yield return 1f;
            
            yield return Textbox.Say("DZ_CH21_MONSTER_UNITY");
            ...
            // More dialog
            yield return Textbox.Say("DZ_CH21_COOPERATION_SUCCESS");
            
            yield return 1f;
            
            yield return Textbox.Say("DZ_CH21_NEW_FUTURE");
            ...
            yield return Textbox.Say("DZ_CH21_LOOK_TO_SKY");
            ...
            yield return Textbox.Say("DZ_CH21_PLANET_WONDER");
            ...
            // Final dialog
            yield return Textbox.Say("DZ_CH21_TWO_WORLDS_ONE");
