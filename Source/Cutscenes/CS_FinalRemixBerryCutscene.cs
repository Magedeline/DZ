...
public class CS_FinalRemixBerryCutscene : CutsceneEntity
{
    ...
    private const string GOLDEN_DIALOG_KEY = "DZ_CH19_21_GOLDEN_BERRY";
    private const string PINK_PLAT_DIALOG_KEY = "DZ_CH19_21_PINK_PLATINUM_BERRY";
    ...
    // SFX Events
    private const string SFX_GOLDEN_GLOW = "event:/Mods/pusheen/new_content/game/19_spaces/golden_glow";
    private const string SFX_HAND_GRAB = "event:/Mods/pusheen/new_content/char/bosses/asriel/emotional_reunion";
    private const string SFX_GRANNY_STEPS = "event:/new_content/char/madeline/screenentry_gran_landing";
    private const string SFX_TEARS = "event:/Mods/pusheen/new_content/char/bosses/asriel/fade_to_flower";
    private const string SFX_HEART_GEM_APPEAR = "event:/game/general/heart_gem_appear";
    private const string SFX_HEART_GEM_PULSE = "event:/Mods/pusheen/new_content/game/19_spaces/golden_glow";
...
/// </summary>
[CustomEntity(ids: "DZ/FinalRemixBerryCutsceneTrigger")]
[Tracked]
