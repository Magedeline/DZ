...
namespace Celeste.Cutscenes
{
    ...
    public class CsPart1Credit : Oui
    {
        ...
        private const string music_event = "event:/Mods/pusheen/music/lvl9/epilouge/outro";
        #endregion
        ...
        public override void Update()
        {
            ...
            {
                Logger.Log(LogLevel.Error, "DZ", $"Error in CsPart1Credit.Update: {ex}");
            }
        }
        ...
        public override void Render()
        {
            ...
            {
                Logger.Log(LogLevel.Error, "DZ", $"Error in CsPart1Credit.Render: {ex}");
            }
        }
        #endregion
