...
internal static class CutsceneEventDispatcher
{
    ...
    private static Dictionary<string, CutsceneRegistration> CreateCutsceneEvents()
    {
        ...
        AddCutscene(handlers, new[] { "cs20_ending", "cs21_ending", "ch21_ending", "ch20_ending" }, "ch20_true_end_trigger", ctx => new CS21_Ending(ctx.Player));
        ...
        AddCutscene(handlers, "ch20_end_cinematic", "ch20_end_cinematic_trigger", ctx => new CS21_Ending(ctx.Player));
        AddCutscene(handlers, "ch20_cast", "ch20_cast", ctx => new CS21_Cast(ctx.Player));
