...
namespace Celeste.Cutscenes
{
    ...
    public class IntroWarning : Scene
    {
        ...
        public static void Load()
        {
            ...
            Logger.Log(LogLevel.Info, "DZ", "IntroWarning hooks loaded");
        }
        ...
        public static void Unload()
        {
            ...
            On.Celeste.Overworld.Begin -= OnOverworldBegin;
            Logger.Log(LogLevel.Info, "DZ", "IntroWarning hooks unloaded");
        }
        ...
        public static void MarkSeen()
        {
            ...
            if (settings != null)
            {
                ...
                global::Celeste.Mod.DZ.DZModule.Instance.SaveSettings();
            }
        }
