...
namespace Celeste.Cutscenes
{
    ...
    public class VesselCreationVignette : Scene
    {
        ...
        // Audio events
        private const string CREATION_MUSIC_EVENT = "event:/Mods/pusheen/music/lvl0/creation/create";
        private const string DRONE_MUSIC_EVENT = "event:/Mods/pusheen/music/lvl0/creation/drone";
        private const string HEART_APPEAR_EVENT = "event:/Mods/pusheen/music/lvl0/creation/heart_appear";
        private const string HEART_CHANGE_EVENT = "event:/Mods/pusheen/music/lvl0/creation/heart_change";
        ...
        // Graphics â€“ indexed arrays, one entry per sprite variant
        ...
        private IEnumerator vesselDiscardPhase()
        {
            ...
            // No player choice â€” the vessel is simply discarded, faithful to Deltarune
            yield return 2f;
        }
        ...
        private IEnumerator transitionToIntroVignette()
        {
            ...
            FadeWipe whiteFade = new FadeWipe(this, false, () =>
            {
                ...
                if (DZModule.SaveData != null)
                {
                    DZModule.SaveData.HasSeenModIntro = true;
        ...
        // Convenience overload â€“ callers that don't need the index
