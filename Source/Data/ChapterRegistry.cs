...
internal static class ChapterRegistry
{
    ...
    public static void RegisterAllChapters(List<AreaMapData.ChapterDef> chapters)
    {
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            ...
            Icon = "areas/DZ/prolouge", Has1 = false, Has2 = false, HasDSide = false, HasDXSide = false,
        });
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            ...
            Icon = "areas/DZ/city", Has1 = true, Has2 = true, HasDSide = true, HasDXSide = false,
        });
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            ...
            Icon = "areas/DZ/star", Has1 = true, Has2 = true, HasDSide = true, HasDXSide = false,
        });
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            ...
            Icon = "areas/DZ/legend", Has1 = true, Has2 = true, HasDSide = true, HasDXSide = false,
        });
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            ...
            Icon = "areas/DZ/resort", Has1 = true, Has2 = true, HasDSide = true, HasDXSide = false,
        });
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            ...
            Icon = "areas/DZ/stronghold", Has1 = true, Has2 = true, HasDSide = true, HasDXSide = false,
        });
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            ...
            Icon = "areas/DZ/hell", Has1 = true, Has2 = true, HasDSide = true, HasDXSide = false,
        });
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            ...
            Icon = "areas/DZ/truth", Has1 = true, Has2 = true, HasDSide = true, HasDXSide = false,
        });
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            ...
            Icon = "areas/DZ/summit", Has1 = true, Has2 = true, HasDSide = true, HasDXSide = false,
        });
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            ...
            Icon = "areas/DZ/ruins", Has1 = true, Has2 = true, HasDSide = true, HasDXSide = false,
        });
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            ...
            Icon = "areas/DZ/snow", Has1 = true, Has2 = true, HasDSide = true, HasDXSide = false,
        });
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            ...
            Icon = "areas/DZ/water", Has1 = true, Has2 = true, HasDSide = true, HasDXSide = false,
        });
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            ...
            Icon = "areas/DZ/fire", Has1 = true, Has2 = true, HasDSide = true, HasDXSide = false,
        });
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            ...
            Icon = "areas/DZ/digital", Has1 = true, Has2 = true, HasDSide = true, HasDXSide = false,
        });
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            ...
            Icon = "areas/DZ/castle", Has1 = true, Has2 = true, HasDSide = true, HasDXSide = false,
        });
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            ...
            Icon = "areas/DZ/postepilogue", Has1 = false, Has2 = false, HasDSide = false, HasDXSide = false,
        });
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            ...
            Icon = "areas/DZ/heart", Has1 = true, Has2 = true, HasDSide = true, HasDXSide = false,
        });
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            ...
            Icon = "areas/DZ/farewell", Has1 = false, Has2 = false, HasDSide = false, HasDXSide = false,
        });
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            ...
            Icon = "areas/DZ/theend", Has1 = false, Has2 = false, HasDSide = false, HasDXSide = false,
        });
        ...
        Register(chapters, new AreaMapData.ChapterDef
        {
            ...
            Icon = "areas/DZ/lastlevel", Has1 = false, Has2 = false, HasDSide = false, HasDXSide = false,
        });
