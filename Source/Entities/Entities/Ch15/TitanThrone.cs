namespace Celeste.Entities.Chapters.Ch15
{
    ...
    public class TitanThrone : Actor
    {
        ...
        {
            Initialize(
                data.Attr("bossEntity", "DZ/KingTitanBoss"),
                data.Float("activationRadius", 100f),
                data.Bool("autoActivate", false),
                data.Attr("cutsceneId", "DZ_CH15_ROARING_TITAN_KING_BATTLE")
            );
        }

        public TitanThrone(Vector2 position, string bossEntity = "DZ/KingTitanBoss",
            float activationRadius = 100f, bool autoActivate = false, string cutsceneId = "DZ_CH15_ROARING_TITAN_KING_BATTLE")
            : base(position)
        {
        ...
        private IEnumerator VictoryRoutine()
        {
            ...
            // Victory dialogue
            yield return Textbox.Say("DZ_CH15_VICTORY");
    ...
    /// </summary>
    [CustomEntity("DZ/ThroneRoomController")]
