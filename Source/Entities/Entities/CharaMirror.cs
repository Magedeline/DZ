...
namespace Celeste.Entities
{
    ...
    public class CharaMirror : Entity
    {
        ...
        public IEnumerator BreakRoutine(int direction)
        {
            ...
            charaMirror.sfx.Play("event:/Mods/pusheen/game/02_nightmare/sequence_mirror");
            yield return 0.15f;
            charaMirror.Add(charaMirror.sfxSting = new SoundSource("event:/Mods/pusheen/music/lvl2/dreamblock_sting_pt2"));
