...
{
    [CustomEntity(ids: "DZ/CharaMirror")]
    [Tracked]
    [HotReloadable]
    public class CharaMirror : Entity
    {
        private Image frame;
        private MTexture glassbg = GFX.Game["objects/DZ/mirror/glassbg"];
        private MTexture glassfg = GFX.Game["objects/DZ/mirror/glassfg"];
            ...
            : base(position)
        {
            ...
            foreach (MTexture atlasSubtexture in GFX.Game.GetAtlasSubtextures("objects/DZ/mirror/mirrormask"))
            {
        ...
        public override void Added(Scene scene)
        {
            ...
            else
            {
                ...
                reflectionHair.Color = Calc.HexToColor("FFD700");
            ...
            entity.Add(frame = new Image(GFX.Game["objects/DZ/mirror/frame"]));
        ...
        public IEnumerator BreakRoutine(int direction)
        {
            ...
            charaMirror.sfx.Play("event:/DZ/game/02_shadow/sequence_mirror");
            yield return 0.15f;
            charaMirror.Add(charaMirror.sfxSting = new SoundSource("event:/DZ/music/lvl2/dreamblock_sting_pt2"));
