...
{
    [CustomEntity(ids: "DZ/FakeHeartGem")]
    public class FakeHeartGem : Entity
    {
        ...
        private void OnPlayer(global::Celeste.Player player)
        {
            ...
            Logger.Log(LogLevel.Info, "DZ", "Player collected fake heart gem");
        ...
        private void Respawn()
        {
            ...
            var settings = DZModule.Settings as global::Celeste.Mod.DZ.DZModuleSettings;
            if (settings != null && settings.DebugMode)
            {
                Logger.Log(LogLevel.Debug, "DZ", "Fake heart gem respawning");
            }
