...
{
    [CustomEntity(ids: "DZ/HeartGemSattelite")]
    [Tracked]
    public class HeartGemSattelite : Entity
    {
        ...
        public static readonly Dictionary<string, string> Sounds = new Dictionary<string, string>
        {
            {
                "D",
                "event:/Mods/pusheen/game/01_metro/console_blue"
            },
            {
                "U",
                "event:/Mods/pusheen/game/01_metro/console_red"
            },
            {
                "L",
                "event:/Mods/pusheen/game/01_metro/console_purple"
            },
            {
                "R",
                "event:/Mods/pusheen/game/01_metro/console_yellow"
            }
        };
        ...
        private IEnumerator PulseRoutine()
        {
            ...
            while (heartGemSattelite.enabled)
            {
                ...
                for (int i = 0; i < HeartGemSattelite.Code.Length && heartGemSattelite.enabled; ++i)
                {
                    ...
                    yield return 0.5f;
                    heartGemSattelite.pulseBloom.Visible = heartGemSattelite.pulse.Visible = false;
                    Audio.Play(i < HeartGemSattelite.Code.Length - 1 ? "event:/Mods/pusheen/game/01_metro/console_static_short" : "event:/Mods/pusheen/game/01_metro/console_static_long", heartGemSattelite.Position + heartGemSattelite.computer.Position);
                    yield return 0.2f;
                }
                ...
                heartGemSattelite.Add(Alarm.Create(Alarm.AlarmMode.Oneshot, delegate
                {
                        if (enabled)
                        {
                                ...
                                birdThrustSfx.Play("event:/Mods/pusheen/game/01_metro/birdbros_thrust");
                        }
                }, 1.1f, true));
        ...
        private IEnumerator UnlockGem()
        {
            ...
            heartGemSattelite.birdFinishSfx.Play("event:/Mods/pusheen/game/01_metro/birdbros_finish");
            heartGemSattelite.staticLoopSfx.Play("event:/Mods/pusheen/game/01_metro/console_static_loop");
