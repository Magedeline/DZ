...
namespace Celeste.Entities.Items
{
    ...
    public abstract class KirbyFood : Entity
    {
        ...
        protected const string SFX_HEAL = "event:/Mods/pusheen/char/kirby/heal";
    ...
    /// </summary>
    [CustomEntity("DZ/InvincibilityCandy")]
    [Tracked]
