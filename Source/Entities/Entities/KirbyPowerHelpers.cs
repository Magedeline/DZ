...
namespace Celeste.Entities
{
    ...
    {
        private const string SFX_DASH_LEFT = "event:/DZ/char/kirby/dash_red_left";
        private const string SFX_DASH_RIGHT = "event:/DZ/char/kirby/dash_red_right";
        private const string SFX_DASHDZ_CHARGE = "event:/DZ/char/kirby/dashDZ_CHarge";
    ...
    {
        private const string SFX_KNIGHT_TRANSFORM = "event:/DZ/char/kirby/kirby_knight/backflip";
        private const string SFX_KNIGHT_ATTACK = "event:/DZ/char/kirby/kirby_knight/punch_A";
        private const string SFX_KNIGHT_SPECIAL = "event:/DZ/char/kirby/kirby_knight/spin";
