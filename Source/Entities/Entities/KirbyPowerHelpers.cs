...
namespace Celeste.Entities
{
    ...
    {
        private const string SFX_DASH_LEFT = "event:/Mods/pusheen/char/kirby/dash_red_left";
        private const string SFX_DASH_RIGHT = "event:/Mods/pusheen/char/kirby/dash_red_right";
        private const string SFX_DASH_CHARGE = "event:/Mods/pusheen/char/kirby/dash_charge";
    ...
    {
        private const string SFX_KNIGHT_TRANSFORM = "event:/Mods/pusheen/char/kirby/kirby_knight/backflip";
        private const string SFX_KNIGHT_ATTACK = "event:/Mods/pusheen/char/kirby/kirby_knight/punch_A";
        private const string SFX_KNIGHT_SPECIAL = "event:/Mods/pusheen/char/kirby/kirby_knight/spin";
