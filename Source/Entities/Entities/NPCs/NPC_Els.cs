...
namespace Celeste.NPCs
{
    ...
    public class NPC_Els : NpcBase
    {
        ...
        public NPC_Els(EntityData data, Vector2 offset) : base(data.Position + offset, "DZ_CH16_CORRUPTED_REALITY_INTRO")
        {
            ...
            try
            {
                ...
                switch (elsForm)
                {
                    case "flowey":
                        ...
                        CutsceneId = "DZ_CH15_FLOWEY_ATTACK";
                        break;
                    case "genocider":
                        sprite.Color = Color.DarkRed;
                        sprite.Scale = Vector2.One * 1.5f;
                        CutsceneId = "DZ_CH16_CORRUPTED_REALITY_INTRO";
                        break;
                    case "corrupted":
                        sprite.Color = Color.Purple;
                        sprite.Scale = Vector2.One * 2.0f;
                        CutsceneId = "DZ_CH16_FINAL_CONFRONTATION";
                        break;
                }
        ...
        protected override void Interact(global::Celeste.Player player)
        {
            if (!Interacting)
            {
                ...
                {
                    "flowey" => "DZ_CH15_FLOWEY_ATTACK",
                    "genocider" => "DZ_CH16_CORRUPTED_REALITY_INTRO", 
                    "corrupted" => "DZ_CH16_FINAL_CONFRONTATION",
                    _ => CutsceneId
                };
