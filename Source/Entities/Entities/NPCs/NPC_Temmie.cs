        ...
        private void OnTalk(global::Celeste.Player player)
        {
            ...
            switch (shopStage)
            {
                case 1:
                    ...
                    // Scene.Add(new MultiCharacterCutscene(player, "DZ_CH12_TEMMIE_ROOM_TEM_SHOP_1"));
                    break;
                case 2:
                    level?.Session.SetFlag("temmie_shop_2");
                    // MultiCharacterCutscene doesn't exist
                    // Scene.Add(new MultiCharacterCutscene(player, "DZ_CH12_TEMMIE_ROOM_TEM_SHOP_2"));
                    break;
                default:
                    // MultiCharacterCutscene doesn't exist
                    // Scene.Add(new MultiCharacterCutscene(player, "DZ_CH12_TEMMIE_ROOM_TEM_SHOP_END"));
                    break;
            }
