namespace Celeste.Entities
{
    ...
    public class UltraDashBlock : Solid
    {
        ...
        private const string SFX_BREAK_GENERAL = "event:/DZ/game/general/break_stone";
        private const string SFX_BREAK_SPACE = "event:/DZ/new_content/game/19_spaces/space_break_stone";
        private const string SFX_BREAK_UNDERWATER = "event:/DZ/game/general/underwater_break_stone";
