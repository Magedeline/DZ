		...
		public override void Update()
		{
			...
			if (this.enabled && this.sprite.CurrentAnimationID != "hatch")
			{
				...
				else
				{
					...
					if (speedSign != 0 && facingSign != speedSign && Math.Sign(Input.Aim.Value.X) == Math.Sign(this.speed.X) && Math.Abs(this.speed.X) > 20f && this.sprite.CurrentAnimationID != "flipMouth" && this.sprite.CurrentAnimationID != "flipEyes")
					{
