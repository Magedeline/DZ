...
namespace Celeste.Entities
{
    ...
    public class PopstarBerry : Actor, IStrawberry
    {
        ...
        private const string AudioElaborate  = "event:/Mods/pusheen/game/general/strawberry_get";
        ...
        private void OnPlayer(global::Celeste.Player player)
        {
            ...
            Audio.Play("event:/Mods/pusheen/game/general/strawberry_get", Position, "colour", 5f);
