    ...
    public class PowerGenerator : Solid
    {
        ...
        public DashCollisionResults Dashed(global::Celeste.Player player, Vector2 dir)
        {
            ...
            if (this.health > 0)
            {
                ...
                {
                    this.firstHitSfx = new SoundSource("event:/new_content/game/pusheen/19_spaces/powergenerator_hit_first");
                    this.Add((Component)this.firstHitSfx);
                }
                else
                {
                    // Play multiple hits sound for subsequent hits
                    Audio.Play("event:/new_content/game/pusheen/19_spaces/powergenerator_hit", this.Position);
                }
        ...
        private void @break()
        {
            ...
            var sfx = Audio.Play("event:/new_content/game/pusheen/19_spaces/powergenerator_hit_scream", this.Position);
