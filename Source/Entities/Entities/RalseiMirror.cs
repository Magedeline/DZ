...
{
    [CustomEntity(new string[] { "DZ/RalseiMirror" })]
    public class RalseiMirror : Entity
    {
        ...
        public IEnumerator BreakRoutine(int direction)
        {
            ...
            yield return 0.15f;
            ralseiMirror.Add((Component)(ralseiMirror.sfxSting = new SoundSource("event:/Mods/pusheen/music/lvl4/dreamblock_sting_pt2")));
