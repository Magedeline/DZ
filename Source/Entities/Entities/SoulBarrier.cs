...
namespace Celeste.Entities
{
    ...
    /// </summary>
    [CustomEntity(ids: "DesoloZantas/SoulBarrier,DZ/SoulBarrier")]
    [Tracked]
    public class SoulBarrier : Solid
    {
        ...
        public override void Added(Scene scene)
        {
            ...
            {
                fragmentsCollected = global::Celeste.Mod.DZ.DZModule.SaveData?.GetCollectedSoulFragmentsForBarrier(barrierId) ?? 0;
            }
    ...
    /// </summary>
    [CustomEntity(ids: "DesoloZantas/SoulFragment,DZ/SoulFragment")]
    [Tracked]
    public class SoulFragment : Entity
    {
        ...
        private void OnPlayer(global::Celeste.Player player)
        {
            ...
            if (session != null && !string.IsNullOrEmpty(barrierId))
            {
                ...
                global::Celeste.Mod.DZ.DZModule.SaveData?.CollectSoulFragment(key, barrierId);
            }
