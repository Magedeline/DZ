...
{
  [CustomEntity(ids: "DZ/TesseractMirrorPortal")]
  public class TesseractMirrorGateway : Entity
  {
    ...
    private void beforeRender()
    {
      ...
      MTexture mtexture = GFX.Game["objects/DZ/temple/portal/portal"];
    ...
    public override void Render()
    {
      ...
      GFX.Game["objects/DZ/temple/portal/portalframe"].DrawCentered(this.Position);
    ...
    {
      Level level = this.SceneAs<Level>();
      if (!this.canTrigger || level == null || !level.Session.GetFlag(this.GetUnlockedFlag()))
        return;
    ...
    private class Bg : Entity
    {
      ...
      {
        this.Depth = 9500;
        this.textures = GFX.Game.GetAtlasSubtextures("objects/DZ/temple/portal/reflection");
      ...
      public override void Render()
      {
        GFX.Game["objects/DZ/temple/portal/surface"].DrawCentered(this.Position);
      }
    }
