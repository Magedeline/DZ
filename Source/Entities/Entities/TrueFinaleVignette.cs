...
{
    private const string VignetteMusicEvent = "event:/DZ/new_content/music/lvl21/climb";
    ...
    public TrueFinaleVignette(Session session, HiresSnow snow = null)
    {
        ...
        titleText = Dialog.Has("DZ_TRUEFINALE_TITLE")
            ? Dialog.Clean("DZ_TRUEFINALE_TITLE")
            : "THE LAST PUSH";
    ...
    public override void Render()
    {
        ...
        if (titleAlpha > 0f)
        {
            ...
            {
                ActiveFont.DrawOutline(
                    Dialog.Has("DZ_TRUEFINALE_CONTINUE")
                        ? Dialog.Clean("DZ_TRUEFINALE_CONTINUE")
