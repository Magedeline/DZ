...
internal class LargeHeartGemDoor : Entity
{
    ...
    public IEnumerator Routine()
    {
        ...
        if (this.startHidden)
        {
            ...
            Audio.Play("event:/pusheen/final_content/game/19_the_end/large_heart_door", this.Position);
            this.Visible = true;
            this.heartAlpha = 0f;
        ...
        while (!this.opened && this.counter < this.requires)
        {
            ...
            {                
                if (this.counter == 0.0f && this.heartGems > 0)
                    Audio.Play("event:/pusheen/game/18_heart/frontdoor_heartfill", this.Position);
    ...
    private IEnumerator OpenCutscene(Level level)
    {
        ...
        this.cutsceneMusic = Audio.Play("event:/pusheen/final_content/music/lvl19/cinematic/BEB_cutscenes", this.Position);
