    ...
    public static class DeathlinkIntegration
    {
        ...
        private static void RegisterPauseMenuOption()
        {
            ...
            try
            {
                ...
                // For now, the toggle can be triggered via console command: "DZ_deathlink_toggle"
                settingRegistered = true;
                Logger.Log(LogLevel.Info, "DeathlinkIntegration", "Deathlink toggle registered (use console command: DZ_deathlink_toggle)");
            }
            catch (Exception ex)
            {
