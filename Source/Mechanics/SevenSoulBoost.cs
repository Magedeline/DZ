...
namespace Celeste.Entities.SoulBoosts
{
    ...
    /// </summary>
    [CustomEntity(ids: "DZ/SevenSoulBoost")]
    [Tracked]
    public class SevenSoulBoost : Entity
    {
        ...
        Level level = Scene as Level;
            ...
            if (finalCh21Boost)
            {
                Audio.Play("event:/Mods/pusheen/new_content/char/madeline/final_launch_part1", Position);
            }
            else if (!finalBoost)
            {
                Audio.Play("event:/Mods/pusheen/new_content/char/madeline/ready", Position);
            }
            else
            {
                Audio.Play("event:/Mods/pusheen/new_content/char/madeline/launch", Position);
            }
            ...
            else
            {
                if (finalCh21Boost)
                {
                    Ch21FinalBoostSfx = Audio.Play("event:/Mods/pusheen/new_content/char/madeline/final_launch_part2", Position);
                }
