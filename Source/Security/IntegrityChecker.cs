    ...
    public static class IntegrityChecker
    {
        ...
        public static bool VerifyAssemblyIntegrity()
        {
            ...
            try
            {
                ...
                {
                    Logger.Log(LogLevel.Warn, "DZ", "Debugger detected — integrity check skipped.");
                    return false;
                }
                ...
                {
                    Logger.Log(LogLevel.Info, "DZ", $"[Integrity] Assembly hash (embed this in release): {actualHash}");
                    return true;
                }
            ...
            {
                Logger.Log(LogLevel.Error, "DZ", $"[Integrity] Assembly check failed: {ex.Message}");
                return false;
            }
#endif
        }
