...
namespace Celeste.Triggers
{
    ...
    /// </summary>
    [CustomEntity(ids: "DZ/RainbowBlackholeTrigger")]
    [HotReloadable]
        ...
        private void ApplyActionToBackdrop(RainbowBlackholeBg backdrop)
        {
            switch (action)
            {
                ...
                case ActionType.ChangeStrength:
                    ...
                    {
                        backdrop.RainbowMode = RainbowBlackholeBg.Strengths.Insane;
                        backdrop.SetStrength(RainbowBlackholeBg.Strengths.Insane);
                    }
                    else
                    {
                        backdrop.RainbowMode = (RainbowBlackholeBg.Strengths)(int)strengthLevel;
                ...
                case ActionType.SetDirection:
                    backdrop.Direction = new Microsoft.Xna.Framework.Vector2(directionValue, 0f);
                    break;
