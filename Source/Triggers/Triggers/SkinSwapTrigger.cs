...
namespace Celeste.Triggers {
    [CustomEntity("DZ/SkinSwapTrigger")]
    [HotReloadable]
    public class SkinSwapTrigger : Trigger {
        ...
        public override void OnEnter(CelestePlayer player) {
            ...
            Logger.Log(LogLevel.Info, "DZ/SkinSwapTrigger", $"Swapped to character: {characterId}");
        }
        ...
        private void SwapToCharacter(string newCharacterId, CelestePlayer player)
        {
            ...
            try
            {
                ...
                CharacterAbilityRegistry.ActivateCharacter(newCharacterId, true, true);
                
                Logger.Log(LogLevel.Info, "DZ/SkinSwapTrigger", 
                    $"Activated character abilities for: {newCharacterId}");
            }
            catch (Exception ex)
            {
                Logger.Log(LogLevel.Error, "DZ/SkinSwapTrigger", 
